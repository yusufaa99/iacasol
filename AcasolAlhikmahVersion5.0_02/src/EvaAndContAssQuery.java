...
public class EvaAndContAssQuery extends JFrame
{
    ...
    private JComboBox ComboOrderBy;
    
    static {
        EvaAndContAssQuery.printer = new J2Printer("");
    }
    
    public EvaAndContAssQuery() {
    ...
    public static void setOnScreen(final boolean val) {
        EvaAndContAssQuery.onScreen = val;
    }
    
    public void EvaAndContAssQuery() {
        final Font f2 = new Font(null, 1, 20);
        final Font f3 = new Font("Arial Unicode MS", 1, 20);
        ...
        this.ComboSelecClass.setFont(f3);
        ...
        this.lblOrderBY = new JLabel("SORT BY:");
        (this.ComboOrderBy = new JComboBox()).setFont(f3);
        this.ComboOrderBy.addItem("RegNum");
        this.ComboOrderBy.addItem("Subject");
        ...
        final JScrollPane ScrollPane = new JScrollPane(table, 22, 30);
        ScrollPane.setPreferredSize(new Dimension(430, 940));
        ...
        this.paneScrollPane.setPreferredSize(new Dimension(900, 390));
        this.textPane.insertIcon(new ImageIcon("EvaQueryReportlogo.jpg"));
        ...
        this.setTitle("Evaluations and Cont. Assessment Query Window - For Secondary School");
        this.add(this.panel);
        ...
        this.addItem(this.panel, this.lblOrderBY, 0, 6, 1, 1, 13);
        this.addItem(this.panel, this.ComboOrderBy, 1, 6, 3, 1, 17);
        ...
        OverallTotalBox.add(Box.createHorizontalStrut(5));
        this.addItem(this.panel, this.paneScrollPane, 1, 15, 6, 3, 10);
        this.panel.validate();
        this.panel.repaint();
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                EvaAndContAssQuery.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                EvaAndContAssQuery.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                EvaAndContAssQuery.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.btnSubjectGaringMethod(evt15);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt16) {
                EvaAndContAssQuery.this.connectToDB();
                EvaAndContAssQuery.this.ComboSelecClassMethod(evt16);
            }
        });
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int col) {
                ...
                final Font d = new Font("Arial Unicode MS", 1, 10);
                table.setFont(d);
                ...
                column5.setPreferredWidth(102);
                final TableColumn column6 = table.getColumnModel().getColumn(5);
                column6.setPreferredWidth(125);
                final TableColumn column7 = table.getColumnModel().getColumn(9);
                column7.setPreferredWidth(110);
                final TableColumn column8 = table.getColumnModel().getColumn(10);
                column8.setPreferredWidth(85);
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        final String Grade = this.txtSubjectGrading.getText().toString();
        final String Remark = this.txtRemark.getText().toString();
        final String OrderBy = (String)this.ComboOrderBy.getSelectedItem();
        final String myclasses = this.txtmyClass.getText().toString();
        final String myterm = this.txtmyterm.getText().toString();
        final String myNoInClass = this.txtmyNoinClass.getText().toString();
        final String myGrade = this.txtmyGrade.getText().toString();
        ...
        try {
            ...
            final String QueryString = "SELECT  ID,RegNum,Name,Class,Term,Date,Total,Exam,Test,Subject_ENG,Subject,Session FROM dataentryacasolarabic WHERE Class=? and Term=? order by " + OrderBy;
            final PreparedStatement pstatement = con.prepareStatement(QueryString);
