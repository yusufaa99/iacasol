...
public class ReportSheet extends JFrame
{
    ...
    public void ReportSheet() {
        ...
        this.textPane.insertIcon(new ImageIcon("reportSheetNurserySection.jpg"));
        ...
        (this.lblReportRaqm = new JLabel("Reg. Number: ")).setAlignmentY(0.5f);
        ...
        this.setTitle("Report Sheet Output Window [Nursery Section]");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ReportSheet.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ReportSheet.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ReportSheet.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnSubjectGaringMethod(evt15);
            }
        });
        ...
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ReportSheet.this.connectToDB();
                ReportSheet.this.btnPreviousMethod(evt18);
            }
        });
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int col) {
                ...
                int tablerowsize = 0;
                final String myClass = (String)ReportSheet.this.ComboSelecClass.getSelectedItem();
                ...
                else if (rowCountForStud <= 3) {
                    tablerowsize = (int) (rowCountForStud * 24);
                }
                else if (rowCountForStud == 4) {
                    tablerowsize = (int) (rowCountForStud * 22);
                }
                else if (rowCountForStud == 5) {
                    tablerowsize = (int) (rowCountForStud * 20);
                }
                else if (rowCountForStud == 6) {
                    tablerowsize = (int) (rowCountForStud * 20);
                } else if ( rowCountForStud >=7 ) {
                    tablerowsize =  (int) (rowCountForStud * 18);
                }else if ( rowCountForStud >=12 ) {
                    tablerowsize =  (int) (rowCountForStud * 9);
                }else if ( rowCountForStud >=14 ) {
                    tablerowsize = (int) (rowCountForStud * 1);
                }
                ReportSheet.this.ScrollPane.setPreferredSize(new Dimension(600, tablerowsize));
                tablerowsize = 0;
                return this;
            }
        });
    ...
    public void btnPrintMethod(final ActionEvent evt6) {
        ...
        pj.setPrintable(new Printable() {
            ...
            public int print(final Graphics pg, final PageFormat pf, final int pageNum) {
                ...
                g2.translate(10, 35);
                ReportSheet.this.textPane.paint(g2);
                return 0;
            }
        });
        if (pj.printDialog()) {
        ...
        if (mySession.equals("Select Session")) {
            ...
            try {
               // final String QueryString = "SELECT Subject_ENG,Mulahazah,POSITION,REMARKS,TOTAL,EXAMS_60,CA_40,SUBJECT FROM compiledreportsheet WHERE ID=? and Class=? and Term=? AND Session = ? order by CASE WHEN Subject IN ('\u0627\u0644\u0642\u0631\u0622\u0646 \u0643\u062a\u0627\u0628\u0629','\u0639\u0644\u0648\u0645 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u062d\u0631\u0648\u0641 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645 \u062d\u0641\u0638\u0627','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645') THEN -1 ELSE Subject END, Subject ASC";
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT Subject_ENG,Grade,POSITION,REMARKS,TOTAL,EXAMS_60,CA_40,SUBJECT FROM compiledreportsheet WHERE ID=? and Class=? and Term=? AND Session = ? order by CASE WHEN Subject IN ('\u0627\u0644\u0642\u0631\u0622\u0646 \u0643\u062a\u0627\u0628\u0629','\u0639\u0644\u0648\u0645 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u062d\u0631\u0648\u0641 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645 \u062d\u0641\u0638\u0627','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645') THEN -1 ELSE Subject END, Subject ASC");
                pstatement.setString(1, ID);
                pstatement.setString(2, myclass);
