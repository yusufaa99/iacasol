...
public class CheckForBehaviours extends JFrame
{
    ...
    public void CheckForBehaviours() {
        ...
        this.ComboSelectBehaviour.setEditable(true);
        this.ComboSelectBehaviour.setFont(this.f);
        ...
        this.btnSave = new JButton("Check");
        ...
        this.setSize(835, 484);
        this.setTitle("Check For The Correctness Of Behaviours");
        this.add(this.panel);
        ...
        this.addItem(this.panel, this.lblBehavior, 0, 7, 1, 1, 13);
        this.addItem(this.panel, this.ComboSelectBehaviour, 1, 7, 3, 1, 17);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                CheckForBehaviours.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                CheckForBehaviours.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                CheckForBehaviours.this.connectToDB();
                CheckForBehaviours.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                CheckForBehaviours.this.connectToDB();
                CheckForBehaviours.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                CheckForBehaviours.this.connectToDB();
                CheckForBehaviours.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                CheckForBehaviours.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                CheckForBehaviours.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                CheckForBehaviours.this.connectToDB();
                CheckForBehaviours.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                CheckForBehaviours.this.connectToDB();
                CheckForBehaviours.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    CheckForBehaviours.this.btnSave.doClick();
                }
            }
        });
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    CheckForBehaviours.this.btnNext.doClick();
                }
            }
        });
    ...
    public void btnSaveMethod(final ActionEvent evt5) {
        ...
        final String myBehaviour = (String)this.ComboSelectBehaviour.getSelectedItem();
        final String myClassName_Ara = this.ComboSelecClass.getSelectedItem().toString();
        final String mySubject_Ara = this.ComboSelectSubj.getSelectedItem().toString();
        try {
            this.connectToDB();
        ...
        if (mySession.equals("Select Session")) {
            ...
            JOptionPane.showMessageDialog(null, "Please, select term, class, subject or subject!", "Error", 0);
        }
        else if (myBehaviour.equals("SELECT BEHAVIOUR")) {
            JOptionPane.showMessageDialog(null, "Please, select behaviour!", "Error", 0);
        }
...
//        }
            ...
            Label_0947: {
                try {
                    this.connectToDB();
                    final String QueryString = "SELECT  StdRegNum FROM " + this.pulledClassName_Eng.replaceAll("-", "_").replaceAll("\\s","").toLowerCase() + " WHERE StdRegNum NOT IN (SELECT distinct RegNum  FROM behaviour WHERE CLASS= ? AND session= ?  AND Term = ? AND Behaviour = ?  AND Behaviour  LIKE '%')";
                    final PreparedStatement pstatement = this.connection.prepareStatement(QueryString);
                    pstatement.setString(1, myclass);
                    pstatement.setString(2, mySession);
                    pstatement.setString(3, term);
                    pstatement.setString(4, myBehaviour);
                    final ResultSet rs = pstatement.executeQuery();
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        if (mySession.equals("Select Session")) {
            ...
            try {
                ...
                //final String QueryString = "SELECT ID,RegNum,Name,Class,Term,Subject,Subject_ENG,Test,Exam,Total,Remarks, FIND_IN_SET(Total, (SELECT GROUP_CONCAT(Total ORDER BY Total DESC) FROM dataentryacasolarabic where subject=? AND Class=? AND Term=? AND Session=?)) As Position,Session FROM dataentryacasolarabic where subject=? AND Class=? AND Term=? AND Session=? order by ID";
