...
public class ExamOfficer extends JFrame
{
    ...
    static {
        ExamOfficer.printer = new J2Printer("");
    }
    ...
    public void ExamOfficer() {
        ...
        this.paneScrollPane.setPreferredSize(new Dimension(610, 220));
        this.textPane.insertIcon(new ImageIcon("RSlogo.jpg"));
        ...
        this.textPane.insertComponent(this.lblReportTatal);
        (this.txtReportTatal = new JTextField(10)).setAlignmentY(0.5f);
        this.txtReportTatal.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.txtReportTatal);
        (this.lblReportOutOf = new JLabel("OUT OF: ")).setAlignmentY(0.5f);
        this.lblReportOutOf.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.lblReportOutOf);
        (this.txtReportOutOf = new JTextField(8)).setAlignmentY(0.5f);
        this.txtReportOutOf.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.txtReportOutOf);
        ...
        this.textPane.insertComponent(this.lblReportClassPosition);
        (this.txtReportClassPosition = new JTextField(5)).setAlignmentY(0.5f);
        this.txtReportClassPosition.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.txtReportClassPosition);
        (this.lblReportExamOffrReport = new JLabel("EXAM OFFICER'S REPORT: ")).setAlignmentY(0.5f);
        this.lblReportExamOffrReport.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.lblReportExamOffrReport);
        (this.txtReportExamOffrReport = new JTextField(30)).setAlignmentY(0.5f);
        this.txtReportExamOffrReport.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.txtReportExamOffrReport);
        (this.txtblankSpace3 = new JTextField(70)).setEditable(false);
        this.txtblankSpace3.setBackground(Color.gray);
        (this.lblReportExamOffrReport = new JLabel("EXAMS OFFICER'S SIGN: ")).setAlignmentY(0.5f);
        this.lblReportExamOffrReport.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.lblReportExamOffrReport);
        ...
        this.textPane.insertIcon(new ImageIcon("principal.png"));
        ...
        this.lblReportProprietorSignature4.setAlignmentX(0.1f);
        this.textPane.insertComponent(this.lblReportProprietorSignature4);
        this.textPane.insertIcon(new ImageIcon("proprietor.png"));
        this.setIconImage(new ImageIcon("LogoInReportSheet.gif").getImage());
        this.setVisible(true);
        this.setResizable(true);
        this.setSize(640, 650);
        this.setTitle("Exam Officer Comment Window - For Secondary School");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ExamOfficer.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ExamOfficer.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ExamOfficer.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnSubjectGaringMethod(evt15);
            }
        });
        this.btnStaffSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt16) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnStaffSearchMethod(evt16);
            }
        });
        btnCommentAndSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt17) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.btnCommentAndSave(evt17);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ExamOfficer.this.connectToDB();
                ExamOfficer.this.ComboSelecClassMethod(evt18);
            }
        });
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        if (this.txtName.getText().equals("") || this.txtName.getText().equals("")) {
            ...
            try {
                ...
                final String QueryString = "SELECT Subject,CA,Exam,Total,Grade,Position,Remarks FROM compiledreportsheet WHERE ID=? and Form=? and Class=? and Term=? ";
                final PreparedStatement pstatement = con.prepareStatement("SELECT Subject,CA,Exam,Total,Grade,Position,Remarks FROM compiledreportsheet WHERE ID=? and Form=? and Class=? and Term=? ");
                pstatement.setString(1, ID);
            ...
            this.panel.repaint();
            try {
                final String QueryString2 = "SELECT COUNT(*) Subject FROM CompiledReportSheet WHERE ID = ? AND Term =? AND Form =?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT COUNT(*) Subject FROM CompiledReportSheet WHERE ID = ? AND Term =? AND Form =?");
                ...
                while (rs2.next()) {
                    ...
                    this.txtReportOutOf.setText(Double.toString(OutOf));
                }
                rs2.close();
                pstatement2.close();
            }
            ...
            try {
                final String QueryString2 = "SELECT TermEnds,NxtTermBegins FROM TermInformation WHERE Term =?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT TermEnds,NxtTermBegins FROM TermInformation WHERE Term =?");
            ...
            try {
                final String QueryString2 = "SELECT NoInClass FROM compiledreportsheet WHERE ID=? and Form=? and Class=? and Term=? ";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT NoInClass FROM compiledreportsheet WHERE ID=? and Form=? and Class=? and Term=? ");
                pstatement2.setString(1, ID);
            ...
            try {
                final String QueryString2 = "SELECT OvrllTotal FROM overalltotalandaverage WHERE ID=? and Form=? and Class=? and Term=? ";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT OvrllTotal FROM overalltotalandaverage WHERE ID=? and Form=? and Class=? and Term=? ");
                pstatement2.setString(1, ID);
                pstatement2.setString(2, form);
                pstatement2.setString(3, myclass);
                pstatement2.setString(4, term);
                ...
                while (rs2.next()) {
                    ...
                    this.txtReportTatal.setText(total);
                }
                rs2.close();
                pstatement2.close();
            }
            ...
            try {
                final String QueryString2 = "SELECT Average FROM overalltotalandaverage WHERE ID = ? AND Term =? AND Form =? AND Class=?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT Average FROM overalltotalandaverage WHERE ID = ? AND Term =? AND Form =? AND Class=?");
                pstatement2.setString(1, ID);
                pstatement2.setString(2, term);
                pstatement2.setString(3, form);
                ...
                while (rs2.next()) {
                    ...
                    this.txtReportAverage.setText(String.format("%.4f", avg));
                }
                rs2.close();
                pstatement2.close();
            }
            ...
            try {
                final String QueryString2 = "SELECT ID,RegNum FROM compiledreportsheet WHERE ID=? and Form=? and Class=? and Term=? ";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT ID,RegNum FROM compiledreportsheet WHERE ID=? and Form=? and Class=? and Term=? ");
                pstatement2.setString(1, ID);
                pstatement2.setString(2, form);
                pstatement2.setString(3, myclass);
                pstatement2.setString(4, term);
            ...
            try {
                final String QueryString2 = "SELECT RegNum,Name, FIND_IN_SET(OvrllTotal, (SELECT GROUP_CONCAT(OvrllTotal ORDER BY OvrllTotal DESC) FROM overalltotalandaverage where Class=? AND Term=? AND Form=?)) As Position FROM overalltotalandaverage where ID=? AND Class=? AND Term=? AND Form=? order by Position";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT RegNum,Name, FIND_IN_SET(OvrllTotal, (SELECT GROUP_CONCAT(OvrllTotal ORDER BY OvrllTotal DESC) FROM overalltotalandaverage where Class=? AND Term=? AND Form=?)) As Position FROM overalltotalandaverage where ID=? AND Class=? AND Term=? AND Form=? order by Position");
                pstatement2.setString(1, myclass);
                pstatement2.setString(2, term);
                pstatement2.setString(3, form);
                pstatement2.setString(4, ID);
                pstatement2.setString(5, myclass);
                pstatement2.setString(6, term);
                pstatement2.setString(7, form);
                final ResultSet rs2 = pstatement2.executeQuery();
                final int Reg = 0;
                while (rs2.next()) {
                    final int result2 = rs2.getInt(3);
                    if (result2 == 1) {
        ...
        try {
            final String QueryString3 = "SELECT Comment FROM examformExamOfficercomment WHERE ID=? and Form=? and Class=? and Term=? ";
            final PreparedStatement pstatement3 = this.connection.prepareStatement("SELECT Comment FROM examformExamOfficercomment WHERE ID=? and Form=? and Class=? and Term=? ");
        ...
        try {
            final String QueryString3 = "SELECT Comment FROM ExamHouseMasterComment WHERE ID=? and Form=? and Class=? and Term=? ";
            final PreparedStatement pstatement3 = this.connection.prepareStatement("SELECT Comment FROM ExamHouseMasterComment WHERE ID=? and Form=? and Class=? and Term=? ");
            pstatement3.setString(1, ID);
            pstatement3.setString(2, form);
            pstatement3.setString(3, myclass);
            pstatement3.setString(4, term);
        ...
        try {
            final String QueryString3 = "SELECT Comment FROM ExamPrincipalComment WHERE ID=? and Form=? and Class=? and Term=? ";
            final PreparedStatement pstatement3 = this.connection.prepareStatement("SELECT Comment FROM ExamPrincipalComment WHERE ID=? and Form=? and Class=? and Term=? ");
            pstatement3.setString(1, ID);
            pstatement3.setString(2, form);
            pstatement3.setString(3, myclass);
            pstatement3.setString(4, term);
        ...
        try {
            final String QueryString3 = "SELECT Comment FROM ExamProprietorComment WHERE ID=? and Form=? and Class=? and Term=? ";
            final PreparedStatement pstatement3 = this.connection.prepareStatement("SELECT Comment FROM ExamProprietorComment WHERE ID=? and Form=? and Class=? and Term=? ");
            pstatement3.setString(1, ID);
            pstatement3.setString(2, form);
            pstatement3.setString(3, myclass);
            pstatement3.setString(4, term);
    ...
    public void btnCommentAndSave(final ActionEvent evt17) {
        ...
        if (term.equals("SELECT TERM") || form.equals("SELECT FORM") || myclass.equals("SELECT CLASS")) {
            ...
            try {
                final String InsertQueryString = "INSERT INTO examformExamOfficercomment VALUES (?,?,?,?,?,?,?,?,?)";
                final PreparedStatement pstatement = this.connection.prepareStatement("INSERT INTO examformExamOfficercomment VALUES (?,?,?,?,?,?,?,?,?)");
                pstatement.setString(1, ID);
    ...
    public void ExamOverallTotalAndAverageTerm1JSS1BlueMethod() {
        ...
        try {
            ...
            final int Reg = 0;
            while (rs.next()) {
                final double myAverage = rs.getInt(1);
                this.txtReportAverage.setText(Double.toString(myAverage));
                final double myOvrllTotal = rs.getInt(2);
