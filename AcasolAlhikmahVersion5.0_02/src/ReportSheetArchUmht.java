...
public class ReportSheetArchUmht extends JFrame
{
    ...
    static {
        ReportSheetArchUmht.printer = new J2Printer("");
    }
    
    public ReportSheetArchUmht() {
    ...
    public static void setOnScreen(final boolean val) {
        ReportSheetArchUmht.onScreen = val;
    }
    
    public void ReportSheetArchUmht() {
        this.logotitle = "";
        ...
        this.setTitle("Report Sheet Output Window [ARCHIVED - UMMAHAT]");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ReportSheetArchUmht.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ReportSheetArchUmht.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ReportSheetArchUmht.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnSubjectGaringMethod(evt15);
            }
        });
        ...
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ReportSheetArchUmht.this.connectToDB();
                ReportSheetArchUmht.this.btnPreviousMethod(evt18);
            }
        });
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int col) {
                ...
                int tablerowsize = 0;
                final String myClass = (String)ReportSheetArchUmht.this.ComboSelecClass.getSelectedItem();
                if (myClass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0623\u0648\u0644") || myClass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062b\u0627\u0646\u064a")) {
                    tablerowsize = 165;
                }
                ...
                else if (ReportSheetArchUmht.this.rowCountForStud <= 3) {
                    tablerowsize = ReportSheetArchUmht.this.rowCountForStud * 24;
                }
                else if (ReportSheetArchUmht.this.rowCountForStud == 4) {
                    tablerowsize = ReportSheetArchUmht.this.rowCountForStud * 22;
                }
                else if (ReportSheetArchUmht.this.rowCountForStud == 5) {
                    tablerowsize = ReportSheetArchUmht.this.rowCountForStud * 21;
                }
                else if (ReportSheetArchUmht.this.rowCountForStud == 6) {
                    tablerowsize = ReportSheetArchUmht.this.rowCountForStud * 21;
                }
                ReportSheetArchUmht.this.ScrollPane.setPreferredSize(new Dimension(480, tablerowsize));
                return this;
            }
        });
    ...
    public void btnPrintMethod(final ActionEvent evt6) {
        ...
        pj.setPrintable(new Printable() {
            ...
            public int print(final Graphics pg, final PageFormat pf, final int pageNum) {
                ...
                g2.translate(10, 35);
                ReportSheetArchUmht.this.textPane.paint(g2);
                return 0;
            }
        });
        if (pj.printDialog()) {
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        try {
            ...
            mypstatement2.setString(3, "UMMAHAT");
        ...
        try {
            ...
            pstatement6.setString(2, "UMMAHAT");
