...
public class FormMasterComment extends JFrame
{
    ...
    static {
        FormMasterComment.printer = new J2Printer("");
    }
    
    public FormMasterComment() {
    ...
    public static void setOnScreen(final boolean val) {
        FormMasterComment.onScreen = val;
    }
    
    public void FormMasterComment() {
        ...
        this.paneScrollPane.setPreferredSize(new Dimension(610, 320));
        ...
        final Font f = new Font(null, 0, 12);
        (this.lblReportTerm = new JLabel("REPORT")).setAlignmentY(0.5f);
        this.lblReportTerm.setAlignmentX(0.1f);
        this.lblReportTerm.setFont(f);
        this.textPane.insertComponent(this.lblReportTerm);
        (this.txtReportTerm = new JTextField(5)).setAlignmentY(0.5f);
        ...
        (this.txtReportTermOf = new JTextField(8)).setAlignmentY(0.5f);
        ...
        (this.lblReportRegNum = new JLabel(" ADMISSION NO:")).setAlignmentY(0.5f);
        this.lblReportRegNum.setAlignmentX(0.1f);
        this.lblReportRegNum.setFont(f);
        this.textPane.insertComponent(this.lblReportRegNum);
        (this.txtReportRegNum = new JTextField(8)).setAlignmentY(0.5f);
        ...
        (this.txtReportID = new JTextField(6)).setAlignmentY(0.5f);
        ...
        (this.txtReportSex = new JTextField(10)).setAlignmentY(0.6f);
        ...
        (this.txtReportHouse = new JTextField(18)).setAlignmentY(0.6f);
        ...
        (this.txtReportAttendance = new JTextField(10)).setAlignmentY(0.5f);
        ...
        (this.txtReportDaysOutof = new JTextField(10)).setAlignmentY(0.5f);
        ...
        (this.txtReportScoresObtainable = new JTextField(6)).setAlignmentY(0.5f);
        ...
        (this.txtReportScoresObtained = new JTextField(6)).setAlignmentY(0.5f);
        ...
        (this.txtReportAverage = new JTextField(6)).setAlignmentY(0.5f);
        ...
        (this.txtReportNoInClass = new JTextField(15)).setAlignmentY(0.5f);
        ...
        (this.txtReportClassPosition = new JTextField(13)).setAlignmentY(0.5f);
        ...
        (this.txtReportPrincipalReport = new JTextField(30)).setAlignmentY(0.5f);
        ...
        (this.txtReportNextTermBegins = new JTextField(8)).setAlignmentY(0.5f);
        ...
        (this.txtReportSchFeesBalance = new JTextField(8)).setAlignmentY(0.5f);
        ...
        (this.txtReportSchFeesBalanceTerm = new JTextField(8)).setAlignmentY(0.5f);
        ...
        (this.lblReportPrincipalSignature3 = new JLabel("PRINCIPAL'S SIGN: ")).setAlignmentY(0.99f);
        ...
        this.setSize(690, 715);
        this.setTitle("Class Teacher's Comment Window - For Nursery & Primary Schools");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                FormMasterComment.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                FormMasterComment.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                FormMasterComment.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnSubjectGaringMethod(evt15);
            }
        });
        this.btnStaffSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt16) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnStaffSearchMethod(evt16);
            }
        });
        btnCommentAndSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt17) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.btnCommentAndSave(evt17);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                FormMasterComment.this.connectToDB();
                FormMasterComment.this.ComboSelecClassMethod(evt18);
            }
        });
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        if (this.txtRegNum.getText().equals("") || myclass.equals("")) {
            ...
            try {
                final String QueryString2 = "SELECT RegNum,Name, FIND_IN_SET(OvrllTotal, (SELECT GROUP_CONCAT(OvrllTotal ORDER BY OvrllTotal DESC) FROM overalltotalandaverageNurPry where Class=? AND Term=?)) As Position FROM overalltotalandaverageNurPry where ID=? AND Class=? AND Term=? order by Position";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT RegNum,Name, FIND_IN_SET(OvrllTotal, (SELECT GROUP_CONCAT(OvrllTotal ORDER BY OvrllTotal DESC) FROM overalltotalandaverageNurPry where Class=? AND Term=?)) As Position FROM overalltotalandaverageNurPry where ID=? AND Class=? AND Term=? order by Position");
                pstatement2.setString(1, myclass);
                pstatement2.setString(2, term);
                pstatement2.setString(3, ID);
                pstatement2.setString(4, myclass);
                pstatement2.setString(5, term);
                final ResultSet rs2 = pstatement2.executeQuery();
                final int Reg = 0;
                while (rs2.next()) {
    ...
    public void btnStaffSearchMethod(final ActionEvent evt16) {
        ...
        if (this.txtStaffID.getText().toString().equals("")) {
            ...
            try {
                final String QueryString = "SELECT StaffName FROM staffdatacapturenurandprimary WHERE StaffID =?";
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT StaffName FROM staffdatacapturenurandprimary WHERE StaffID =?");
    ...
    public void btnCommentAndSave(final ActionEvent evt17) {
        ...
        if (term.equals("SELECT TERM") || myclass.equals("SELECT CLASS")) {
            ...
            try {
                final String InsertQueryString = "INSERT INTO ExamFormMasterComment VALUES (?,?,?,?,?,?,?,?,?)";
                final PreparedStatement pstatement = this.connection.prepareStatement("INSERT INTO ExamFormMasterComment VALUES (?,?,?,?,?,?,?,?,?)");
                pstatement.setString(1, ID);
