...
public class CheckForCorrectnessOfDataEntry extends JFrame
{
    ...
    public CheckForCorrectnessOfDataEntry() {
        this.acctCounter = 0;
    ...
    public void CheckForCorrectnessOfDataEntry() {
        ...
        this.setTitle("Check For The Correctness Of Data Entry");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                CheckForCorrectnessOfDataEntry.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                CheckForCorrectnessOfDataEntry.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                CheckForCorrectnessOfDataEntry.this.connectToDB();
                CheckForCorrectnessOfDataEntry.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                CheckForCorrectnessOfDataEntry.this.connectToDB();
                CheckForCorrectnessOfDataEntry.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                CheckForCorrectnessOfDataEntry.this.connectToDB();
                CheckForCorrectnessOfDataEntry.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                CheckForCorrectnessOfDataEntry.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                CheckForCorrectnessOfDataEntry.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                CheckForCorrectnessOfDataEntry.this.connectToDB();
                CheckForCorrectnessOfDataEntry.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                CheckForCorrectnessOfDataEntry.this.connectToDB();
                CheckForCorrectnessOfDataEntry.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    CheckForCorrectnessOfDataEntry.this.btnSave.doClick();
                }
            }
        });
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    CheckForCorrectnessOfDataEntry.this.btnNext.doClick();
                }
            }
        });
    ...
    public void btnSaveMethod(final ActionEvent evt5) {
        ...
        final String wkcombo = (String)this.ComboWeekNumber.getSelectedItem().toString().replaceAll("-", "_").replaceAll("\\s","").toLowerCase();
...
//        }
            ...
            this.data.setSize(0);
            this.columnNames.setSize(0);
            final String TheLikeSubject = "%" + subj + "%";
            Label_0981: {
                try {
                    this.connectToDB();
                    final String QueryString2 = "SELECT  StdRegNum FROM " + this.pulledClassName_Eng.replaceAll("-", "_").replaceAll("\\s","").toLowerCase() + " WHERE StdRegNum NOT IN (SELECT distinct RegNum  FROM dataentryacasolarabic WHERE CLASS= ? AND session= ?  AND Term = ? and subject  LIKE ?)";
                    final PreparedStatement pstatement = this.connection.prepareStatement(QueryString2);
    ...
    public void accessControlMethod() {
        ...
        if (this.myUsername_From_Authentication_Class.equalsIgnoreCase("saif")) {
            ...
            try {
                ...
                rs = pstatement.executeQuery();
                if (rs.next()) {
                     accControlCounter = accControlCounter+1;
