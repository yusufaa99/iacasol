...
public class ClassRegistration extends JFrame
{
    ...
    public void ClassRegistration() {
        ...
        this.ComboSection.addItem("NURSERY SECTION");
        this.ComboSection.addItem("PRIMARY SECTION");
        this.ComboSection.addItem("JUNIOR SECONDARY SECTION");
        this.ComboSection.addItem("SENIOR SECONDARY SECTION");
        ...
        this.setSize(850, 452);
        this.setTitle("[AcasolV5.0_02] Class Registration Window");
        this.add(this.panel);
        ...
        this.addItem(this.panel, this.ComboSelecClass_English, 1, 4, 2, 1, 17);
        ...
        this.addItem(this.panel, this.lblSection, 0, 6, 1, 1, 13);
        this.addItem(this.panel, this.ComboSection, 1, 6, 3, 1, 17);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ClassRegistration.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ClassRegistration.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ClassRegistration.this.connectToDB();
                ClassRegistration.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ClassRegistration.this.connectToDB();
                ClassRegistration.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ClassRegistration.this.connectToDB();
                ClassRegistration.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ClassRegistration.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ClassRegistration.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                ClassRegistration.this.connectToDB();
                ClassRegistration.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ClassRegistration.this.connectToDB();
                ClassRegistration.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    ClassRegistration.this.btnNext.doClick();
                }
            }
        });
        this.ComboSection.addKeyListener(new KeyAdapter() {
            @Override
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    ClassRegistration.this.btnSave.doClick();
                }
            }
        });
        this.btnDeregister.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ClassRegistration.this.btnDeregisterMethod(evt10);
            }
        });
    ...
    public void btnDeregisterMethod(final ActionEvent evt10) {
        ...
        if (DeleteButton == 0) {
            ...
            if (mySession.equals("Select Session")) {
            ...
            else if (myClassName_Eng.equals("SELECT CLASS_ENLISH")) {
                JOptionPane.showMessageDialog(null, "Please, select Subject_Eng!", "Error in Subject_Eng Data Entry", 0);
            }
            else if (myClassName_Arabic.equals("SELECT CLASS")) {
            ...
            else if ("".equals(myClassName_Arabic)) {
                JOptionPane.showMessageDialog(null, "Error: This Class Has been Registered! \n DETAILSArabic: \nEnglish: ", "Error Occured", 0);
            }
            else if ("".equals(myClassName_Eng)) {
                JOptionPane.showMessageDialog(null, "Error: This Class Has been Registered! \n DETAILS: \nArabic: \nEnglish: ", "Error Occured", 0);
            }
            else {
                try {
                    this.connectToDB();
                    final String QueryString = "SELECT Classname_Ara,Classname_Eng FROM class_regsitration WHERE Classname_Ara =? ";
                    final PreparedStatement pstatement = this.connection.prepareStatement("SELECT Classname_Ara,Classname_Eng FROM class_regsitration WHERE Classname_Ara =? ");
                    pstatement.setString(1, myClassName_Arabic);
                    final ResultSet rs = pstatement.executeQuery();
                    if (rs.next()) {
                        ++counterForDeletion;
                    }
                ...
                if (myClassName_Eng.equalsIgnoreCase("") || myClassName_Arabic.equalsIgnoreCase("")) {
                    ...
                    JOptionPane.showMessageDialog(null, "The selectd class does NOT EXIST inside the Databse!", "Error Occured", 0);
                }
                else {
                    try {
                        this.connectToDB();
                        final String QueryString = "DELETE FROM class_regsitration WHERE Classname_Ara =? AND Classname_Eng =?  ";
                        final PreparedStatement pstatement = this.connection.prepareStatement("DELETE FROM class_regsitration WHERE Classname_Ara =? AND Classname_Eng =?  ");
                        pstatement.setString(1, myClassName_Arabic);
                        pstatement.setString(2, myClassName_Eng);
                        pstatement.executeUpdate();
                        pstatement.close();
                        JOptionPane.showMessageDialog(null, "  The  Class " + myClassName_Eng + "\n" + myClassName_Arabic + "\n" + " is been DELETED!");
                    }
                    catch (SQLException a) {
                        JOptionPane.showMessageDialog(null, "please check your entries\n" + a.getMessage(), "Error occured", 0);
                        a.printStackTrace();
                    ...
                    try {
                        ...
                        final PreparedStatement pstatement2 = con.prepareStatement("SELECT * FROM class_regsitration");
    ...
    public void btnSaveMethod(final ActionEvent evt5) {
        ...
        final int SaveButton = JOptionPane.showConfirmDialog(null, "Are you sure you want to Register?", "Registration Confirmation Window", 0);
        if (SaveButton == 0) {
            final String myClassName_Eng = this.ComboSelecClass_English.getSelectedItem().toString();
            final String myClassName_Arch = String.valueOf(String.valueOf(this.ComboSelecClass_English.getSelectedItem().toString())) + "_archive";
            final String myClassName_Arabic = this.ComboSelecClass.getSelectedItem().toString();
            final String mySection = this.ComboSection.getSelectedItem().toString();
            final String mySession = this.ComboSession.getSelectedItem().toString();
            final String ClassStatus = "Active";
            final String ArchiveString = "_archive";
            String TheClassName_Eng = "";
            ...
            String TheModifiedClassname_Eng = myClassName_Eng.replaceAll("-", "_").replaceAll("\\s","").toLowerCase();
            		...
            		try {
                this.connectToDB();
               // final String QueryString = "SELECT Classname_Eng FROM class_regsitration WHERE Classname_Eng =?  ";
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT Classname_Ara,Classname_Eng FROM class_regsitration WHERE Classname_Eng =?  ");
                 pstatement.setString(1, myClassName_Eng);
                final ResultSet rs = pstatement.executeQuery();
                while (rs.next()) {                   
                    TheClassName_Eng = rs.getString(1);
                }
                rs.close();
                pstatement.close();
            }
            ...
            else if (myClassName_Eng.equals("SELECT CLASS")) {
                JOptionPane.showMessageDialog(null, "Please, select Class", "Error in Subject_Eng Data Entry", 0);
            }
//            else if (myClassName_Arabic.equals("SELECT CLASS")) {
//                JOptionPane.showMessageDialog(null, "Please, select Class_Arabic!", "Error in Subject_Arabic Data Entry", 0);
//            }
            else if (mySection.equals("SELECT SECTION")) {
                JOptionPane.showMessageDialog(null, "Please, select Section!!", "Error in section Data Entry", 0);
            }
            ...
            else if (TheClassName_Eng.equals(myClassName_Eng)) {
                JOptionPane.showMessageDialog(null, "Error: This Class Has been Registered! \n DETAILS: \nArabic: " + TheClassName_Arabic + "\n" + "English: " + TheClassName_Eng, "Error Occured", 0);
            }
            else {
            	System.out.println(TheModifiedClassname_Eng);//testing the 
                try {
                    final String InsertQueryString = "CREATE TABLE IF NOT EXISTS " + TheModifiedClassname_Eng + " LIKE demo_table";
                    final PreparedStatement pstatement = this.connection.prepareStatement(InsertQueryString);
                    pstatement.executeUpdate();
                    JOptionPane.showMessageDialog(null, "  The  Class: \n ' " + myClassName_Eng + " ' " + " IS BEEN CREATED!");
                    pstatement.close();
                }
                catch (SQLException e) {
                ...
                try {
                    final String InsertQueryString = "CREATE TABLE IF NOT EXISTS " + TheModifiedClassname_Eng + "_archive" + " LIKE demo_table";
                    final PreparedStatement pstatement = this.connection.prepareStatement(InsertQueryString);
                    pstatement.executeUpdate();
                    JOptionPane.showMessageDialog(null, "  The  Class_Archive : \n ' " + myClassName_Arch + " ' " + " IS BEEN CREATED!");
                    pstatement.close();
                }
                catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Error occured,\n" + e.getMessage());
                ...
                try {
                    //final String InsertQueryString = "INSERT INTO class_regsitration (ClassID,Classname_Eng,Classname_Ara,Classname_Arch,Status,Session,Section)VALUES (?,?,?,?,?,?,?) ";
                    final PreparedStatement pstatement = this.connection.prepareStatement("INSERT INTO class_regsitration VALUES (?,?,?,?,?,?,?) ");
                    pstatement.setString(1, null);
                    pstatement.setString(2, myClassName_Eng);
                    pstatement.setString(3, myClassName_Eng);
                    pstatement.setString(4, myClassName_Arch);
                    pstatement.setString(5, "Active");
                    pstatement.setString(6, mySession);
                    pstatement.setString(7, mySection);
                    pstatement.executeUpdate();
                    JOptionPane.showMessageDialog(null, "  The  Class: " + myClassName_Arabic + "\n  AND " + myClassName_Eng + " AND Class_Archive " + myClassName_Arch + " IS BEEN registered");
                    pstatement.close();
                }
                catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Error occured,\n" + e.getMessage());
                ...
                this.TextArea.setText("");
                if (myClassName_Eng.equalsIgnoreCase("") || myClassName_Arabic.equalsIgnoreCase("")) {
                    JOptionPane.showMessageDialog(null, "Pls, Class_Eng OR Class_Arabic not selected", "Error Occured", 0);
                }
                else {
                    try {
                        this.connectToDB();
                        final String QueryString = "SELECT * FROM class_regsitration";
                        final PreparedStatement pstatement = this.connection.prepareStatement("SELECT * FROM class_regsitration");
                        final ResultSet rs = pstatement.executeQuery();
