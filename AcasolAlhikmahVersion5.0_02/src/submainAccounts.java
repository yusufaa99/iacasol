...
public class submainAccounts extends JFrame implements ActionListener
{
    ...
    public void submainAccounts() {
        this.panel = new JPanel();
        this.btnDataEntryWindows = new JButton("DATA ENTRY WINDOWS");
        this.btnAccounts = new JButton("Accounts");
        ...
        this.setTitle("Sub Main Window - For Accounts");
        this.add(this.panel);
        ...
        this.btnAccounts.setBackground(Color.black);
        this.btnAccounts.setForeground(Color.white);
        ...
        Buttogrp1.add(this.btnAccounts);
        ...
        this.btnDataEntryWindows.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                submainAccounts.this.btnDataEntryWindowsMethod(evt1);
            }
        });
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                submainAccounts.this.btnCloseMethod(evt2);
            }
        });
        this.btnReportOrOutputWindows.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                submainAccounts.this.btnReportOrOutputWindowsMethod(evt3);
            }
        });
        this.btnProcessingWindow.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                submainAccounts.this.btnProcessingWindowWindowMethod(evt4);
            }
        });
        this.btnCompilationWindows.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                submainAccounts.this.btnCompilationWindowsMethod(evt5);
            }
        });
        this.btnQueryWindows.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                submainAccounts.this.btnQueryWindowsMethod(evt6);
            }
        });
        this.btnEditingWindows.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                submainAccounts.this.btnEditingWindowsMethod(evt7);
            }
        });
        this.btnAccounts.addActionListener(new ActionListener() {
            public void actionPerfomed(final ActionEvent e8) {
            }
            
            @Override
            public void actionPerformed(final ActionEvent evt8) {
                submainAccounts.this.btnAccountsMethod(evt8);
            }
        });
    }
    ...
    public void btnAccountsMethod(final ActionEvent evt8) {
        final subFeesManagement fmg = new subFeesManagement();
        fmg.subFeesManagement();
    }
