...
public class CAReport extends JFrame
{
    ...
    static {
        CAReport.printer = new J2Printer("");
    }
    ...
    public void CAReport() {
        ...
        (this.txtRegNum = new JTextField(18)).setEditable(false);
        this.txtName = new JTextField(31);
        ...
        paneScrollPane.setPreferredSize(new Dimension(590, 320));
        ...
        (this.txtReportName = new JTextField(15)).setAlignmentY(0.5f);
        ...
        (this.txtReportRegNum = new JTextField(10)).setAlignmentY(0.5f);
        ...
        (this.txtReportFORM = new JTextField(15)).setAlignmentY(0.5f);
        ...
        (this.txtblankSpace4 = new JTextField(40)).setEditable(false);
        ...
        (this.txtblankSpace3 = new JTextField(30)).setEditable(false);
        ...
        this.setTitle("C.A. Report [C.A.R.] Window - For Secondary School");
        this.add(this.panel);
        this.setDefaultCloseOperation(3);
        this.setLocationRelativeTo(null);
        this.panel.setBackground(Color.orange);
        this.btnClear.setBackground(Color.green.darker());
        this.btnClose.setBackground(Color.green.darker());
        this.btnPreview.setBackground(Color.green.darker());
        this.btnPrint.setBackground(Color.green.darker());
        this.btnNext.setBackground(Color.green.darker());
        this.btnSearch.setBackground(Color.green.darker());
        ...
        this.addItem(this.panel, REgIDBox, 1, 1, 1, 1, 17);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                CAReport.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                CAReport.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                CAReport.this.connectToDB();
                CAReport.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                CAReport.this.connectToDB();
                CAReport.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                CAReport.this.connectToDB();
                CAReport.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                CAReport.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                CAReport.this.connectToDB();
                CAReport.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                CAReport.this.connectToDB();
                CAReport.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                CAReport.this.connectToDB();
                CAReport.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                CAReport.this.connectToDB();
                CAReport.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                CAReport.this.connectToDB();
                CAReport.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                CAReport.this.connectToDB();
                CAReport.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                CAReport.this.connectToDB();
                CAReport.this.btnSubjectGaringMethod(evt15);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt16) {
                CAReport.this.connectToDB();
                CAReport.this.ComboSelecClassMethod(evt16);
            }
        });
    ...
    public void btnNextMethod(final ActionEvent e4) {
        ...
        try {
            ...
            if (myClass.equalsIgnoreCase("SSS1 A")) {
                ...
                if (!rs.isLast()) {
                    rs.next();
                    final String myreg = rs.getObject(1).toString();
                    this.txtRegNum.setText(myreg);
                    final String Name = rs.getObject(2).toString();
                    this.txtName.setText(Name);
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        if (this.txtName.getText().equals("") || this.txtName.getText().equals("")) {
        ...
        else if (this.txtName.getText().equals("") || this.txtRegNum.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Some textboxes are empty, check and fill the required data", "Error in Test score Data Entry", 0);
        }
        else {
            try {
            ...
            try {
                ...
                final int Reg = 0;
                while (rs2.next()) {
                    final int myId = rs2.getInt(1);
                    final String id = String.format("%04d", myId);
                    this.txtID.setText(id);
                    this.txtReportID.setText(id);
        ...
        if (myClass.equals("SELECT CLASS")) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    final double CworkHworkTotal = this.Hwork;
    ...
    public void btnSubjectGaringMethod(final ActionEvent evt15) {
        ...
        if (myClass.equals("SELECT CLASS")) {
            ...
            try {
                final String QueryString = "SELECT CAmarks FROM dataentry WHERE RegNum = ? AND Term =? AND Form = ? AND Subject =? ";
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT CAmarks FROM dataentry WHERE RegNum = ? AND Term =? AND Form = ? AND Subject =? ");
                pstatement.setString(1, RegNumber);
                pstatement.setString(2, term);
                pstatement.setString(3, form);
                pstatement.setString(4, subj);
