...
public class TermInformation extends JFrame
{
    ...
    public void TermInformation() {
        ...
        this.ComboSections.addItem("NURSERY SECTION");
        this.ComboSections.addItem("PRIMARY SECTION");
        this.ComboSections.addItem("JUNIOR SECONDARY SECTION");
        this.ComboSections.addItem("SENIOR SECONDARY SECTION");
        ...
        this.setTitle("Term Information - For Acasol App");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                TermInformation.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                TermInformation.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                TermInformation.this.connectToDB();
                TermInformation.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                TermInformation.this.connectToDB();
                TermInformation.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                TermInformation.this.connectToDB();
                TermInformation.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                TermInformation.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                TermInformation.this.btnPreviewMethod(evt7);
            }
        });
        this.ComboWeekNumber.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                TermInformation.this.connectToDB();
                TermInformation.this.ComboWeekNumberMethod(evt8);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                TermInformation.this.connectToDB();
                TermInformation.this.btnPreviousMethod(evt9);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                TermInformation.this.connectToDB();
                TermInformation.this.ComboSelecClassMethod(evt10);
            }
        });
    }
    ...
    public void btnSaveMethod(final ActionEvent evt5) {
        ...
        if (term.equals("SELECT TERM")) {
            ...
            JOptionPane.showMessageDialog(null, "Please, Supply Section", "Error in  term data entry", 0);
        }
        else {
            ...
            if (TermAttribute.equals("Sch. Fees for the Next Term")) {
                TermAttributeArabic = "\u0631\u0633\u0648\u0645 \u0627\u0644\u0645\u062f\u0631\u0633\u0629 \u0644\u0644\u0641\u062a\u0631\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629";
            }
            System.out.println(Session);
            final String Status = "Active Session";
            try {
                final String InsertQueryString = "INSERT INTO TermInformation(Term,Term_Attribute,Term_Information,Arab_Term_Attribute,Arab_Term_Information,Session,Year,Status,Section)VALUES(?,?,?,?,?,?,?,?,?)";
                final PreparedStatement pstatement = this.connection.prepareStatement("INSERT INTO TermInformation(Term,Term_Attribute,Term_Information,Arab_Term_Attribute,Arab_Term_Information,Session,Year,Status,Section)VALUES(?,?,?,?,?,?,?,?,?)");
                pstatement.setString(1, term);
                pstatement.setString(2, TermAttribute);
                pstatement.setString(3, TermInformation);
                pstatement.setString(4, TermAttribute);
                pstatement.setString(5, TermInformation);
                pstatement.setString(6, Session);
                pstatement.setString(7, TermYear);
                pstatement.setString(8, "Active Session");
                pstatement.setString(9, Section);
                final int numberOfRowsUpdated = pstatement.executeUpdate();
                JOptionPane.showMessageDialog(null, "Term Attribute: = " + TermAttribute + " Term Information: " + TermInformation + " Successfully Stored");
                this.connection.close();
                pstatement.close();
            }
            catch (SQLException e) {
