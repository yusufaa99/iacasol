...
public class editTerminformation extends JFrame
{
    ...
    public void editTerminformation() {
        ...
        this.btnViewInfo = new JButton("View");
        ...
        this.txtTermInformation.setForeground(Color.BLACK);
        this.txtTermInformationArabic.setForeground(Color.BLACK);
        this.setIconImage(new ImageIcon("LogoInReportSheet.gif").getImage());
        this.setVisible(true);
        this.setResizable(false);
        this.setSize(525, 395);
        this.setTitle("Term Information Editing Window- For Acasol Arabic Version");
        this.add(this.panel);
        ...
        this.addItem(this.panel2, this.lblSection, 0, 5, 1, 1, 13);
        this.addItem(this.panel2, this.ComboSections, 1, 5, 3, 1, 17);
        this.addItem(this.panel2, this.lblTermAttribute, 0, 6, 1, 1, 13);
        this.addItem(this.panel2, this.ComboTermAttribute, 1, 6, 3, 1, 17);
        this.addItem(this.panel2, this.lblTermInformation, 0, 7, 1, 1, 13);
        this.addItem(this.panel2, this.txtTermInformation, 1, 7, 3, 1, 17);
        this.addItem(this.panel2, this.lblTermInformationArabic, 0, 8, 1, 1, 13);
        this.addItem(this.panel2, this.txtTermInformationArabic, 1, 8, 3, 1, 17);
        this.txtTermInformationArabic.getInputContext().selectInputMethod(new Locale("ar", "SA"));
        this.addItem(this.panel2, this.lblSession, 0, 9, 1, 1, 13);
        this.addItem(this.panel2, this.txtSession, 1, 9, 3, 1, 17);
        this.txtSession.getInputContext().selectInputMethod(new Locale("ar", "SA"));
        this.addItem(this.panel2, this.lblTermYear, 0, 10, 1, 1, 13);
        this.addItem(this.panel2, this.txtTermYear, 1, 10, 3, 1, 17);
        this.addItem(this.panel3, this.txtMuddatulutlah, 0, 11, 1, 1, 13);
        this.addItem(this.panel3, this.lblMuddatulutlah, 1, 11, 1, 1, 17);
        this.addItem(this.panel3, this.txtBidayatulFatralUlah, 0, 12, 1, 1, 13);
        this.addItem(this.panel3, this.lblBidayatulFatralUlah, 1, 12, 1, 1, 17);
        this.addItem(this.panel3, this.txtRusumalMadrasahLilfatratilKadimar, 0, 13, 1, 1, 13);
        this.addItem(this.panel3, this.lblRusumalMadrasahLilfatratilKadimar, 1, 13, 1, 1, 17);
        this.addItem(this.panel3, this.txtRusumalmadrasahAladdalibiLamtusaddad, 0, 14, 1, 1, 13);
        this.addItem(this.panel3, this.lblRusumalmadrasahAladdalibiLamtusaddad, 1, 14, 1, 1, 17);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                editTerminformation.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                editTerminformation.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.btnNextMethod(evt4);
            }
        });
        this.btnUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.btnUpdateMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                editTerminformation.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                editTerminformation.this.btnPreviewMethod(evt7);
            }
        });
        this.ComboWeekNumber.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.ComboWeekNumberMethod(evt8);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.btnPreviousMethod(evt9);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.ComboSelecClassMethod(evt10);
            }
        });
        this.btnViewInfo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt11) {
                editTerminformation.this.connectToDB();
                editTerminformation.this.btnViewInfoMethod(evt11);
            }
        });
    }
    ...
    public void btnUpdateMethod(final ActionEvent evt5) {
        ...
        final String periodsofHolidays = this.txtPeriodOfHolidays.getText().toString();
        final String NextTermBegins = this.txtNextTermBegins.getText().toString();
        final String SchFeesfoNxtTerm = this.txtSchoolFeesForNextTerm.getText().toString();
        final String OutstandingFees = this.txtFeesOutStanding.getText().toString();
        final String Muddaulutlah = this.txtMuddatulutlah.getText().toString();
        final String Bidayatulfatralulah = this.txtBidayatulFatralUlah.getText().toString();
        final String RusumlilfatralKadimah = this.txtRusumalMadrasahLilfatratilKadimar.getText().toString();
        final String RusumLamtusaddad = this.txtRusumalmadrasahAladdalibiLamtusaddad.getText().toString();
        final String term = (String)this.ComboTerm.getSelectedItem();
        final String TermAttribute = (String)this.ComboTermAttribute.getSelectedItem();
        final String TermInformation = this.txtTermInformation.getText().toString();
        String TermAttributeArabic = "";
        final String TermInformationArabic = this.txtTermInformationArabic.getText().toString();
        ...
        final String Section = (String)this.ComboSections.getSelectedItem();
        if (term.equals("SELECT TERM")) {
            JOptionPane.showMessageDialog(null, "Please, select term!", "Error occured", 0);
        }
        else if (TermAttribute.equals("") || TermInformationArabic.equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(null, "Please, \u0650term attribute! OR term information", "Error in data entry", 0);
        }
        else if (TermInformation.equals("")) {
            JOptionPane.showMessageDialog(null, "Please, term information", "Error in data entry", 0);
        }
        else if (TermYear.equals("")) {
            JOptionPane.showMessageDialog(null, "Please, enter Year", "Error in data entry", 0);
        }
        else if (Session.equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(null, "Please, enter Session", "Error in data entry", 0);
        }
        else if (Section.equals("")) {
            JOptionPane.showMessageDialog(null, "Please, select section", "Error in data entry", 0);
        }
        else {
            if (TermAttribute.equals("Period of Holidays")) {
                TermAttributeArabic = "\u0645\u062f\u0629 \u0627\u0644\u0639\u0637\u0644\u0629 \u0627\u0644\u0645\u062d\u062f\u062f\u0629";
            }
            if (TermAttribute.equals("Next Term Begins")) {
                TermAttributeArabic = "\u0628\u062f\u0627\u064a\u0629 \u0627\u0644\u0641\u062a\u0631\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629";
            }
            if (TermAttribute.equals("Sch. Fees for the Next Term")) {
                TermAttributeArabic = "\u0631\u0633\u0648\u0645 \u0627\u0644\u0645\u062f\u0631\u0629 \u0644\u0644\u0641\u062a\u0631\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629";
            }
            final String Status = "Active Session";
            try {
                final String QueryString = "UPDATE\tTermInformation SET Term_Information =?, Arab_Term_Information=?, Session=?, Year=? WHERE Term = ? AND Term_Attribute=? AND Session=? AND Year=? AND Section=?";
                (this.pstatement = this.connection.prepareStatement("UPDATE\tTermInformation SET Term_Information =?, Arab_Term_Information=?, Session=?, Year=? WHERE Term = ? AND Term_Attribute=? AND Session=? AND Year=? AND Section=?")).setString(1, TermInformation);
                this.pstatement.setString(2, TermInformationArabic);
                this.pstatement.setString(3, Session);
                this.pstatement.setString(4, TermYear);
                this.pstatement.setString(5, term);
                this.pstatement.setString(6, TermAttribute);
                this.pstatement.setString(7, Session);
                this.pstatement.setString(8, TermYear);
                this.pstatement.setString(9, Section);
                this.pstatement.executeUpdate();
                final String message_for_SuccessfulModification = "\n term information has been modified successfully.";
                JOptionPane.showMessageDialog(null, "\n term information has been modified successfully.", "Successful Modification", 1);
    ...
    public void btnViewInfoMethod(final ActionEvent e11) {
        this.txtTermInformationArabic.setText("");
        this.txtTermInformation.setText("");
        final String form = (String)this.ComboForm.getSelectedItem();
        final String myclass = (String)this.ComboSelecClass.getSelectedItem();
        final String subj = (String)this.ComboSelectSubj.getSelectedItem();
        final String day = (String)this.ComboDay.getSelectedItem();
        ...
        if (term.equals("SELECT TERM")) {
        ...
        else if (TermAttribute.equals("")) {
            JOptionPane.showMessageDialog(null, "Please, enter \u0650term attribute!", "Error in data entry", 0);
        }
        else if (TermYear.equals("") || Session.equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(null, "Please, enter Year OR Session", "Error in data entry", 0);
        }
            ...
            final String Status = "Active Session";
            try {
                final String QueryString = "SELECT  Term_Information, Arab_Term_Information FROM TermInformation WHERE term=? AND Term_Attribute=? AND Session=? AND Year=? AND Section=?";
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT  Term_Information, Arab_Term_Information FROM TermInformation WHERE term=? AND Term_Attribute=? AND Session=? AND Year=? AND Section=?");
                pstatement.setString(1, term);
                pstatement.setString(2, TermAttribute);
                pstatement.setString(3, Session);
                pstatement.setString(4, TermYear);
                pstatement.setString(5, Section);
                final ResultSet rs = pstatement.executeQuery();
                while (rs.next()) {
                    final String myTermInformation = rs.getString(1);
                    this.txtTermInformation.setText(myTermInformation);
                    final String myArabicTermInformation = rs.getString(2);
                    final Font arabfont = new Font("HMSKhabar", 1, 20);
                    this.txtTermInformationArabic.setFont(arabfont);
                    this.txtTermInformationArabic.setText(myArabicTermInformation);
                }
                rs.close();
                this.connection.close();
                pstatement.close();
