...
public class StudRegQuery extends JFrame
{
    ...
    static {
        StudRegQuery.printer = new J2Printer("");
    }
    ...
    public static void setOnScreen(final boolean val) {
        StudRegQuery.onScreen = val;
    }
    
    public void StudRegQuery() {
        ...
        this.setTitle("Stud Reg Query [S.R.Q.]");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                StudRegQuery.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                StudRegQuery.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                StudRegQuery.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnPreviewMethod(evt7);
            }
        });
        this.btnRearrangeClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnRearrangeClassMethod(evt8);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                StudRegQuery.this.connectToDB();
                StudRegQuery.this.btnSubjectGaringMethod(evt15);
            }
        });
    ...
    public void btnRearrangeClassMethod(final ActionEvent evt8) {
        ...
        TemporaryTableName = "tempo" + StudClassRegTableName;
        if (myclass.equalsIgnoreCase("SELECT CLASS")) {
            JOptionPane.showMessageDialog(null, "Pls, select class!\n", "Error Occured", 0);
        }
        else {
            try {
                final String QueryString = "CREATE TEMPORARY TABLE " + TemporaryTableName + " LIKE " + StudClassRegTableName;
            ...
            try {
                final String InsertQueryString = "INSERT INTO " + TemporaryTableName + " (StdID,StDName,StdRegNum,StdClass,StdPicture,DOB,SEX,Nationality,State,PlaceOfBirth,ParentName,ParentNationality,ParentOccupation,ParentGSM) SELECT Null,StDName,StdRegNum,StdClass,StdPicture,DOB,SEX,Nationality,State,PlaceOfBirth,ParentName,ParentNationality,ParentOccupation,ParentGSM FROM " + StudClassRegTableName;
            ...
            try {
                final String InsertQueryString = "INSERT INTO " + StudClassRegTableName + " SELECT * FROM " + TemporaryTableName;
                final PreparedStatement pstatement = this.connection.prepareStatement(InsertQueryString);
                pstatement.executeUpdate();
            }
            catch (SQLException e) {
            ...
            try {
                final String InsertQueryString = "DROP TABLE " + TemporaryTableName;
                final PreparedStatement pstatement = this.connection.prepareStatement(InsertQueryString);
                pstatement.executeUpdate();
            }
            catch (SQLException e) {
            ...
            try {
                final String QueryString2 = "UPDATE " + StudClassRegTableName + " SET StdRegNum=concat(LEFT(StdRegNum , 10),StdID+'')";
