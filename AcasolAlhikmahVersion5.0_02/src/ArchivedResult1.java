...
public class ArchivedResult1 extends JFrame
{
    ...
    private JLabel lblPromoGradYear;
    private JTextField txtPromoGradYear;
    ...
    public static void setOnScreen(final boolean val) {
        ArchivedResult1.onScreen = val;
    }
    
    public void ArchivedResult1() {
        this.logotitle = "";
        ...
        final Font f5 = new Font("Arial Unicode MS", 1, 9);
        ...
        (this.txtRegNum = new JTextField(10)).setFont(f2);
        ...
        (this.txtSession = new JTextField(9)).setFont(f2);
        this.lblPromoGradYear = new JLabel("PRO/GRAD YEAR:");
        (this.txtPromoGradYear = new JTextField(9)).setFont(f2);
        ...
        (this.ScrollPane2 = new JScrollPane(table2, 21, 31)).setPreferredSize(new Dimension(480, 182));
        ...
        this.textPane.insertIcon(new ImageIcon("tahfeezSectionLogo.jpg"));
        ...
        this.setSize(740, 699);
        this.setTitle("Report Sheet Output Window [Tahfeez Type I- ArchivedResult[I]]");
        this.add(this.panel);
        ...
        this.btnPreview.setBackground(Color.GREEN.darker());
        ...
        this.addItem(this.panel, this.txtRegNum, 1, 2, 1, 1, 17);
        ...
        this.addItem(this.panel, this.lblPromoGradYear, 0, 7, 1, 1, 13);
        this.addItem(this.panel, this.txtPromoGradYear, 1, 7, 1, 1, 17);
        this.addItem(this.panel, this.lblSession, 0, 8, 1, 1, 13);
        this.addItem(this.panel, this.txtSession, 1, 8, 1, 1, 17);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ArchivedResult1.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ArchivedResult1.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ArchivedResult1.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnSubjectGaringMethod(evt15);
            }
        });
        ...
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ArchivedResult1.this.connectToDB();
                ArchivedResult1.this.btnPreviousMethod(evt18);
            }
        });
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int col) {
                ...
                colMawad.setHeaderValue("\u0645\u0648\u0627\u062f");
                final TableColumn colTaqweem = colModel.getColumn(6);
                colTaqweem.setHeaderValue(" \u062a/\u0645\u0633\u062a\u0642\u0645");
                ...
                colAlmulahazah.setHeaderValue("\u0627\u0644\u0645\u0644\u0627\u062d\u0638\u0629 ");
                ...
                int tablerowsize = 0;
                final String myClass = (String)ArchivedResult1.this.ComboSelecClass.getSelectedItem();
                ...
                if (myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0631\u0627\u0628\u0639\u0629  \u0627\u0644\u0643\u0628\u0631\u0649") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0631\u0627\u0628\u0639\u0629  \u0627\u0644\u0635\u063a\u0631\u0649")) {
                    tablerowsize = 120;
                }
                if (myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0627\u0644\u0635\u063a\u0631\u0649") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0627\u0644\u0643\u0628\u0631\u0649") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629  \u0627\u0644\u0635\u063a\u0631\u0649") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629  \u0627\u0644\u0643\u0628\u0631\u0649") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0627\u0644\u0643\u0628\u064a\u0631\u0629 \u0623") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0627\u0644\u0643\u0628\u064a\u0631\u0629 \u0628") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u0649 \u0627\u0644\u0635\u063a\u064a\u0631\u0629 \u0623") || myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u0649 \u0627\u0644\u0635\u063a\u064a\u0631\u0629 \u0628")) {
                    tablerowsize = 85;
                }
                if (myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0628") || myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0623") || myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0628") || myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0623") || myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0623\u0648\u0644\u0649 \u0628") || myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0623\u0648\u0644\u0649 \u0623") || myClass.equalsIgnoreCase("\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0623\u0637\u0641\u0627\u0644 \u0628") || myClass.equalsIgnoreCase("\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0623\u0637\u0641\u0627\u0644 \u0623")) {
                    tablerowsize = 99;
                }
                else if (ArchivedResult1.this.rowCountForStud <= 3) {
                    tablerowsize = ArchivedResult1.this.rowCountForStud * 24;
                }
                else if (ArchivedResult1.this.rowCountForStud == 4) {
                    tablerowsize = ArchivedResult1.this.rowCountForStud * 22;
                }
                else if (ArchivedResult1.this.rowCountForStud == 5) {
                    tablerowsize = ArchivedResult1.this.rowCountForStud * 21;
                }
                else if (ArchivedResult1.this.rowCountForStud == 6) {
                    tablerowsize = ArchivedResult1.this.rowCountForStud * 21;
                }
                ArchivedResult1.this.ScrollPane.setPreferredSize(new Dimension(600, tablerowsize));
                tablerowsize = 0;
                return this;
            }
        });
    ...
    public void btnNextMethod(final ActionEvent e4) {
        ...
        try {
            ...
            if (myClass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0623\u0648\u0644\u0649 \u0623")) {
                ...
                String RefrencedClass = "";
                if (myClass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0633\u0627\u062f\u0633\u0629 \u0627\u0644\u0643\u0628\u0631\u0649") || myClass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0623") || myClass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0628") || myClass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0633\u0627\u062f\u0633")) {
                    RefrencedClass = String.valueOf(String.valueOf(myClass)) + " Graduated" + this.txtPromoGradYear.getText().toString();
                }
                else {
                    RefrencedClass = String.valueOf(String.valueOf(myClass)) + " Promoted" + this.txtPromoGradYear.getText().toString();
                }
                final String QueryString2 = "SELECT StdID,StdName,StdClass,StdRegNum FROM studentreghadanatuladfala_Archive WHERE StdRegNum = ? AND StdClass = ?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT StdID,StdName,StdClass,StdRegNum FROM studentreghadanatuladfala_Archive WHERE StdRegNum = ? AND StdClass = ?");
                pstatement2.setString(1, Regnum);
                pstatement2.setString(2, RefrencedClass);
                final ResultSet rs2 = pstatement2.executeQuery();
                while (rs2.next()) {
                    final String Name2 = rs2.getObject(2).toString();
                    this.txtName.setText(Name2);
                    final String Class2 = rs2.getObject(3).toString();
                    this.txtClass.setText(Class2);
                    final String Regnnum2 = rs2.getObject(4).toString();
                    this.txtRegNum.setText(Regnnum2);
                    this.panel.repaint();
                    rs2.close();
                    pstatement2.close();
                }
    ...
    public void btnPrintMethod(final ActionEvent evt6) {
        ...
        pj.setPrintable(new Printable() {
            ...
            public int print(final Graphics pg, final PageFormat pf, final int pageNum) {
                ...
                g2.translate(25, 50);
                ArchivedResult1.this.textPane.paint(g2);
                return 0;
            }
        });
        if (pj.printDialog()) {
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        final String PromGradYear = this.txtPromoGradYear.getText().toString();
        final String mySession = this.ComboSession.getSelectedItem().toString();
        String RefrencedClass = "";
        String RefrencedClass2 = "";
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0633\u0627\u062f\u0633\u0629 \u0627\u0644\u0643\u0628\u0631\u0649") || myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0623") || myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0628") || myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0633\u0627\u062f\u0633") || myclass.equalsIgnoreCase("\u0627\u0644\u062b\u0627\u0644\u062b \u0627\u0644\u062b\u0627\u0646\u0648\u064a")) {
            RefrencedClass = myclass;
            RefrencedClass2 = String.valueOf(String.valueOf(myclass)) + " graduated" + PromGradYear;
        }
        else {
            RefrencedClass = myclass;
            RefrencedClass2 = String.valueOf(String.valueOf(myclass)) + " Promoted" + PromGradYear;
        }
        if (mySession.equals("Select Session")) {
            ...
            JOptionPane.showMessageDialog(null, "Some textboxes are empty, check and fill the required data", "Error in Data Entry", 0);
        }
        else if (this.txtRegNum.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Pls, supply registration number", "Error inData Entry", 0);
        }
        else if (term.equals("SELECT TERM")) {
            JOptionPane.showMessageDialog(null, "pls, select term", "Error in Data Entry", 0);
        }
        else if (this.txtPromoGradYear.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Pls, supply Promotion/Graduation Year", "Error in  Data Entry", 0);
        }
        else if (this.txtSession.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Pls, supply session Year", "Error in  Data Entry", 0);
        }
        else {
            try {
                final String QueryString = "SELECT Subject_ENG,Mulahazah,POSITION,REMARKS,TOTAL,EXAMS_60,CA_40,SUBJECT FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session = ? order by CASE WHEN Subject IN ('\u0627\u0644\u0642\u0631\u0622\u0646 \u0643\u062a\u0627\u0628\u0629','\u0639\u0644\u0648\u0645 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u062d\u0631\u0648\u0641 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645 \u062d\u0641\u0638\u0627','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645') THEN -1 ELSE Subject END, Subject ASC ";
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT Subject_ENG,Mulahazah,POSITION,REMARKS,TOTAL,EXAMS_60,CA_40,SUBJECT FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session = ? order by CASE WHEN Subject IN ('\u0627\u0644\u0642\u0631\u0622\u0646 \u0643\u062a\u0627\u0628\u0629','\u0639\u0644\u0648\u0645 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u062d\u0631\u0648\u0641 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645 \u062d\u0641\u0638\u0627','\u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0643\u0631\u064a\u0645') THEN -1 ELSE Subject END, Subject ASC ");
                pstatement.setString(1, RegNumber);
                pstatement.setString(2, RefrencedClass);
            ...
            this.panel.repaint();
            try {
                final String QueryString2 = "SELECT COUNT(*) Subject FROM compiledreportsheet WHERE Term =? AND RegNum=? AND Class=? AND Session=?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT COUNT(*) Subject FROM compiledreportsheet WHERE Term =? AND RegNum=? AND Class=? AND Session=?");
                pstatement2.setString(1, term);
                pstatement2.setString(2, RegNumber);
                pstatement2.setString(3, RefrencedClass);
            ...
            try {
                final String QueryString2 = "SELECT ID,RegNum,Name FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session=?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT ID,RegNum,Name FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session=?");
                ...
                while (rs2.next()) {
                    ...
                    final String myName = rs2.getString(3);
                    this.txtReportIsmuttalib.setText(myName);
            ...
            try {
                final String QueryString2 = "SELECT Class FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session=?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT Class FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session=?");
                pstatement2.setString(1, RegNumber);
                pstatement2.setString(2, RefrencedClass);
                pstatement2.setString(3, term);
                pstatement2.setString(4, mySession);
            ...
            try {
                final String QueryString2 = "SELECT Behaviour,R1,R2,R3,R4,R5,Behaviour_Arabic FROM Behaviour WHERE RegNum=? and Class=? and Term=? AND Session=?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT Behaviour,R1,R2,R3,R4,R5,Behaviour_Arabic FROM Behaviour WHERE RegNum=? and Class=? and Term=? AND Session=?");
                pstatement2.setString(1, RegNumber);
                pstatement2.setString(2, RefrencedClass);
                pstatement2.setString(3, term);
                pstatement2.setString(4, mySession);
            ...
            this.panel.repaint();
            try {
                final String QueryString3 = "SELECT MaxNoOfDays,DaysAttended,DaysAbsented FROM Attendance WHERE RegNum=? and Class=? and Term=? AND Session=?";
                final PreparedStatement pstatement3 = this.connection.prepareStatement("SELECT MaxNoOfDays,DaysAttended,DaysAbsented FROM Attendance WHERE RegNum=? and Class=? and Term=? AND Session=?");
                pstatement3.setString(1, RegNumber);
                pstatement3.setString(2, RefrencedClass);
            ...
            this.panel.repaint();
            try {
                final String QueryString4 = "SELECT NoInClass,Class,RegNum,ID FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session=?";
                final PreparedStatement pstatement4 = this.connection.prepareStatement("SELECT NoInClass,Class,RegNum,ID FROM compiledreportsheet WHERE RegNum=? and Class=? and Term=? AND Session=?");
                pstatement4.setString(1, RegNumber);
                pstatement4.setString(2, RefrencedClass);
            ...
            try {
                final String QueryString4 = "SELECT OvrllTotal,ID FROM overalltotalandaverageacasolarabic WHERE RegNum=? and Class=? and Term=? AND Session=?";
                final PreparedStatement pstatement4 = this.connection.prepareStatement("SELECT OvrllTotal,ID FROM overalltotalandaverageacasolarabic WHERE RegNum=? and Class=? and Term=? AND Session=?");
                pstatement4.setString(1, RegNumber);
                pstatement4.setString(2, RefrencedClass);
                pstatement4.setString(3, term);
                pstatement4.setString(4, mySession);
            ...
            try {
                final String QueryString4 = "SELECT Average FROM overalltotalandaverageacasolarabic WHERE RegNum = ? AND Term =? AND Class=? AND Session=?";
                final PreparedStatement pstatement4 = this.connection.prepareStatement("SELECT Average FROM overalltotalandaverageacasolarabic WHERE RegNum = ? AND Term =? AND Class=? AND Session=?");
                pstatement4.setString(1, RegNumber);
                pstatement4.setString(2, term);
                pstatement4.setString(3, RefrencedClass);
                pstatement4.setString(4, mySession);
                final ResultSet rs4 = pstatement4.executeQuery();
                while (rs4.next()) {
            ...
            try {
                final String QueryString4 = "SELECT POSITION FROM  compiledreportsheet WHERE RegNum=? AND Class=? AND Term=? AND Session=? group by class";
                final PreparedStatement pstatement4 = this.connection.prepareStatement("SELECT POSITION FROM  compiledreportsheet WHERE RegNum=? AND Class=? AND Term=? AND Session=? group by class");
                pstatement4.setString(1, RegNumber);
                pstatement4.setString(2, RefrencedClass);
                pstatement4.setString(3, term);
                pstatement4.setString(4, mySession);
        ...
        try {
            final String QueryString = "SELECT (SELECT count(*)*100 RequiredTotal FROM compiledreportsheet  WHERE RegNum=? and Class=? and Term=? AND Session=? GROUP BY CLASS),OvrllTotal,Average,( select DISTINCT NoInClass from compiledreportsheet where RegNum=? AND Class=? AND Term=? AND Session=?), (select attaqdeer from attaqdeer where RegNum=? AND Class=? AND Term=? AND Session=?),FIND_IN_SET(OvrllTotal, (SELECT GROUP_CONCAT(OvrllTotal ORDER BY OvrllTotal DESC) FROM overalltotalandaverageacasolarabic where Class=? AND Term=? AND Session=?)) As Position FROM overalltotalandaverageacasolarabic where RegNum=? AND Class=? AND Term=? AND Session=? order by Position";
            final PreparedStatement pstatement = this.connection.prepareStatement("SELECT (SELECT count(*)*100 RequiredTotal FROM compiledreportsheet  WHERE RegNum=? and Class=? and Term=? AND Session=? GROUP BY CLASS),OvrllTotal,Average,( select DISTINCT NoInClass from compiledreportsheet where RegNum=? AND Class=? AND Term=? AND Session=?), (select attaqdeer from attaqdeer where RegNum=? AND Class=? AND Term=? AND Session=?),FIND_IN_SET(OvrllTotal, (SELECT GROUP_CONCAT(OvrllTotal ORDER BY OvrllTotal DESC) FROM overalltotalandaverageacasolarabic where Class=? AND Term=? AND Session=?)) As Position FROM overalltotalandaverageacasolarabic where RegNum=? AND Class=? AND Term=? AND Session=? order by Position");
            pstatement.setString(1, RegNumber);
            pstatement.setString(2, RefrencedClass);
            pstatement.setString(3, term);
            pstatement.setString(4, mySession);
            pstatement.setString(5, RegNumber);
            pstatement.setString(6, RefrencedClass);
            pstatement.setString(7, term);
            pstatement.setString(8, mySession);
            pstatement.setString(9, RegNumber);
            pstatement.setString(10, RefrencedClass);
            pstatement.setString(11, term);
            pstatement.setString(12, mySession);
            pstatement.setString(13, RefrencedClass);
            pstatement.setString(14, term);
            pstatement.setString(15, mySession);
            pstatement.setString(16, RegNumber);
            pstatement.setString(17, RefrencedClass);
        ...
        if (myclass.equalsIgnoreCase("\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0623\u0637\u0641\u0627\u0644 \u0623")) {
            StudClassRegTableName = "studentreghadanatuladfala";
            classProtingsTo = "";
            archivedTable = "studentreghadanatuladfala_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0623\u0637\u0641\u0627\u0644 \u0628")) {
            StudClassRegTableName = "studentreghadanatuladfalb";
            classProtingsTo = "";
            archivedTable = "studentreghadanatuladfalb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0623\u0648\u0644\u0649 \u0623")) {
            StudClassRegTableName = "studentregriyadulquranululaha";
            classProtingsTo = "";
            archivedTable = "studentregriyadulquranululaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u0623\u0648\u0644\u0649 \u0628")) {
            StudClassRegTableName = "studentregriyadulquranululahb";
            classProtingsTo = "";
            archivedTable = "studentregriyadulquranululahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0623")) {
            StudClassRegTableName = "studentregriyadulquranulsaniyaha";
            classProtingsTo = "";
            archivedTable = "studentregriyadulquranulsaniyaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0628")) {
            StudClassRegTableName = "studentregriyadulquranulsaniyahb";
            classProtingsTo = "";
            archivedTable = "studentregriyadulquranulsaniyahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u062c")) {
            StudClassRegTableName = "studentregriyadulquranulsaniyahc";
            classProtingsTo = "";
            archivedTable = "studentregriyadulquranulsaniyahc_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0623")) {
            StudClassRegTableName = "studentregriyadulquranulsalisaha";
            classProtingsTo = "";
            archivedTable = "studentregriyadulquranulsalisaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0631\u064a\u0627\u0636 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0628")) {
            StudClassRegTableName = "studentregriyadulquranulsalisahb";
            archivedTable = "";
            archivedTable = "studentregriyadulquranulsalisahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u0649 \u0627\u0644\u0635\u063a\u064a\u0631\u0629 \u0623")) {
            StudClassRegTableName = "studentreghalaqatululahalsagiraha";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatululahalsagiraha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u0649 \u0627\u0644\u0635\u063a\u064a\u0631\u0629 \u0628")) {
            StudClassRegTableName = "studentreghalaqatululahalsagirahb";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatululahalsagirahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0627\u0644\u0643\u0628\u064a\u0631\u0629 \u0623")) {
            StudClassRegTableName = "studentreghalaqatululahalkabeeraa";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatululahalkabeeraa_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0627\u0644\u0643\u0628\u064a\u0631\u0629 \u0628")) {
            StudClassRegTableName = "studentreghalaqatululahalkabeerab";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatululahalkabeerab_archive";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629  \u0627\u0644\u0643\u0628\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulsaniyaha";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsaniyaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629  \u0627\u0644\u0635\u063a\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulsaniyahb";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsaniyahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0627\u0644\u0643\u0628\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulsalisaha";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsalisaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0627\u0644\u0645\u062a\u0648\u0633\u0637\u0629")) {
            StudClassRegTableName = "studentreghalaqatulsalisahm";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsalisahm_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0627\u0644\u0635\u063a\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulsalisahb";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsalisahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0631\u0627\u0628\u0639\u0629  \u0627\u0644\u0643\u0628\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulrabiaha";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulrabiaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0631\u0627\u0628\u0639\u0629  \u0627\u0644\u0635\u063a\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulrabiahb";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulrabiahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062e\u0627\u0645\u0633\u0629  \u0627\u0644\u0643\u0628\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulkhamisaha";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulkhamisaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u062e\u0627\u0645\u0633\u0629  \u0627\u0644\u0635\u063a\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulkhamisahb";
            archivedTable = "studentreghalaqatulkhamisahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0633\u0627\u062f\u0633\u0629 \u0627\u0644\u0643\u0628\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulsadisaha";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsadisaha_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0644\u0642\u0629 \u0627\u0644\u0633\u0627\u062f\u0633\u0629 \u0627\u0644\u0635\u063a\u0631\u0649")) {
            StudClassRegTableName = "studentreghalaqatulsadisahb";
            classProtingsTo = "";
            archivedTable = "studentreghalaqatulsadisahb_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0635\u063a\u0631\u0649 \u0623")) {
            StudClassRegTableName = "studentreghadanatulsugraha";
            classProtingsTo = "\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0643\u0628\u0631\u0649 \u0623";
            archivedTable = "studentreghadanatulsugraha_archive";
            nextClassTable = "studentreghadanatulkubraha";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0635\u063a\u0631\u0649 \u0628")) {
            StudClassRegTableName = "studentreghadanatulsugrahb";
            classProtingsTo = "\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0643\u0628\u0631\u0649 \u0628";
            archivedTable = "studentreghadanatulsugrahb_archive";
            nextClassTable = "studentreghadanatulkubrahb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0643\u0628\u0631\u0649 \u0623")) {
            StudClassRegTableName = "studentreghadanatulkubraha";
            classProtingsTo = "\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0623";
            archivedTable = "studentreghadanatulkubraha_archive";
            nextClassTable = "studentregraudatululaha";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0643\u0628\u0631\u0649 \u0628")) {
            StudClassRegTableName = "studentreghadanatulkubrahb";
            classProtingsTo = "\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0628";
            archivedTable = "studentreghadanatulkubrahb_archive";
            nextClassTable = "studentregraudatululahb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u062d\u0636\u0627\u0646\u0629 \u0627\u0644\u0643\u0628\u0631\u0649 \u062c")) {
            StudClassRegTableName = "studentreghadanatulkubrahc";
            classProtingsTo = "\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u062c";
            archivedTable = "studentreghadanatulkubrahc_archive";
            nextClassTable = "studentregraudatululahc";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0623")) {
            StudClassRegTableName = "studentregraudatululaha";
            classProtingsTo = "\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0623";
            archivedTable = "studentregraudatululaha_archive";
            nextClassTable = "studentregraudatulsaniyaha";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u0628")) {
            StudClassRegTableName = "studentregraudatululahb";
            classProtingsTo = "\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0628";
            archivedTable = "studentregraudatululahb_archive";
            nextClassTable = "studentregraudatulsaniyahb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u062c")) {
            StudClassRegTableName = "studentregraudatululahc";
            classProtingsTo = "";
            archivedTable = "studentregraudatululahc_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u0623\u0648\u0644\u064a \u062f")) {
            StudClassRegTableName = "studentregraudatululahd";
            classProtingsTo = "";
            archivedTable = "studentregraudatululahd_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0623")) {
            StudClassRegTableName = "studentregraudatulsaniyaha";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0635\u063a\u064a\u0631 \u0623";
            archivedTable = "studentregraudatulsaniyaha_archive";
            nextClassTable = "studentregfaslulauwalussagira";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0628")) {
            StudClassRegTableName = "studentregraudatulsaniyahb";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0635\u063a\u064a\u0631 \u0628";
            archivedTable = "studentregraudatulsaniyahb_archive";
            nextClassTable = "studentregfaslulauwalussagirb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0631\u0648\u0636\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u062c")) {
            StudClassRegTableName = "studentregraudatulsaniyahc";
            classProtingsTo = "";
            archivedTable = "studentregraudatulsaniyahc_archive";
            nextClassTable = "";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0635\u063a\u064a\u0631 \u0623")) {
            StudClassRegTableName = "studentregfaslulauwalussagira";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0643\u0628\u064a\u0631 \u0623";
            archivedTable = "studentregfaslulauwalussagira_archive";
            nextClassTable = "studentregfaslulauwalulkabira";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0635\u063a\u064a\u0631 \u0628")) {
            StudClassRegTableName = "studentregfaslulauwalussagirb";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0643\u0628\u064a\u0631 \u0628";
            archivedTable = "studentregfaslulauwalussagirb_archive";
            nextClassTable = "studentregfaslulauwalulkabirb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0643\u0628\u064a\u0631 \u0623")) {
            StudClassRegTableName = "studentregfaslulauwalulkabira";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0646\u064a \u0623";
            archivedTable = "studentregfaslulauwalulkabira_archive";
            nextClassTable = "studentregfaslussania";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0623\u0648\u0644 \u0627\u0644\u0643\u0628\u064a\u0631 \u0628")) {
            StudClassRegTableName = "studentregfaslulauwalulkabirb";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0646\u064a \u0628";
            archivedTable = "studentregfaslulauwalulkabirb_archive";
            nextClassTable = "studentregfaslussanib";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0646\u064a \u0623")) {
            StudClassRegTableName = "studentregfaslussania";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0644\u062b \u0623";
            archivedTable = "studentregfaslussania_archive";
            nextClassTable = "studentregfaslussalisa";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0646\u064a \u0628")) {
            StudClassRegTableName = "studentregfaslussanib";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0644\u062b \u0628";
            archivedTable = "studentregfaslussanib_archive";
            nextClassTable = "studentregfaslussalisb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0644\u062b \u0623")) {
            StudClassRegTableName = "studentregfaslussalisa";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0631\u0627\u0628\u0639 \u0623";
            archivedTable = "studentregfaslussalisa_archive";
            nextClassTable = "studentregfaslurrabiia";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062b\u0627\u0644\u062b \u0628")) {
            StudClassRegTableName = "studentregfaslussalisb";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0631\u0627\u0628\u0639 \u0628";
            archivedTable = "studentregfaslussalisb_archive";
            nextClassTable = "studentregfaslurrabiib";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0631\u0627\u0628\u0639 \u0623")) {
            StudClassRegTableName = "studentregfaslurrabiia";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062e\u0627\u0645\u0633 \u0623";
            archivedTable = "studentregfaslurrabiia_archive";
            nextClassTable = "studentregfaslulkhamisa";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0631\u0627\u0628\u0639 \u0628")) {
            StudClassRegTableName = "studentregfaslurrabiib";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062e\u0627\u0645\u0633 \u0628";
            archivedTable = "studentregfaslurrabiib_archive";
            nextClassTable = "studentregfaslulkhamisb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062e\u0627\u0645\u0633 \u0623")) {
            StudClassRegTableName = "studentregfaslulkhamisa";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0623";
            archivedTable = "studentregfaslulkhamisa_archive";
            nextClassTable = "studentregfaslussadisa";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u062e\u0627\u0645\u0633 \u0628")) {
            StudClassRegTableName = "studentregfaslulkhamisb";
            classProtingsTo = "\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0628";
            archivedTable = "studentregfaslulkhamisb_archive";
            nextClassTable = "studentregfaslussadisb";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0623")) {
            StudClassRegTableName = "studentregfaslussadisa";
            classProtingsTo = "";
            archivedTable = "studentregfaslussadisa_archive";
        }
        if (myclass.equalsIgnoreCase("\u0627\u0644\u0641\u0635\u0644 \u0627\u0644\u0633\u0627\u062f\u0633 \u0628")) {
            StudClassRegTableName = "studentregfaslussadisb";
            classProtingsTo = "";
            archivedTable = "studentregfaslussadisb_archive";
        }
        if (myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0623\u0648\u0644")) {
            StudClassRegTableName = "studentregfaslulummahatalauwal";
            classProtingsTo = "\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062b\u0627\u0646\u064a";
            archivedTable = "studentregfaslulummahatalauwal_archive";
            nextClassTable = "studentregfaslulummahatassani";
        }
        if (myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062b\u0627\u0646\u064a")) {
            StudClassRegTableName = "studentregfaslulummahatassani";
            classProtingsTo = "\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062b\u0627\u0644\u062b";
            archivedTable = "studentregfaslulummahatassani_archive";
            nextClassTable = "studentregfaslulummahatassalis";
        }
        if (myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062b\u0627\u0644\u062b")) {
            StudClassRegTableName = "studentregfaslulummahatassalis";
            classProtingsTo = "\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0631\u0627\u0628\u0639";
            archivedTable = "studentregfaslulummahatassalis_archive";
            nextClassTable = "studentregfaslulummahatarrabii";
        }
        if (myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0631\u0627\u0628\u0639")) {
            StudClassRegTableName = "studentregfaslulummahatarrabii";
            classProtingsTo = "\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062e\u0627\u0645\u0633";
            archivedTable = "studentregfaslulummahatarrabii_archive";
            nextClassTable = "studentregfaslulummahatalkamis";
        }
        if (myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062e\u0627\u0645\u0633")) {
            StudClassRegTableName = "studentregfaslulummahatalkamis";
            classProtingsTo = "\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0633\u0627\u062f\u0633";
            archivedTable = "studentregfaslulummahatalkamis_archive";
            nextClassTable = "studentregfaslulummahatassadis";
        }
        if (myclass.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u0633\u0627\u062f\u0633")) {
            StudClassRegTableName = "studentregfaslulummahatassadis";
            classProtingsTo = "";
            archivedTable = "studentregfaslulummahatassadis_archive";
        }
        String gender2 = "";
        try {
            final String QueryString5 = "SELECT (select count(*) FROM " + archivedTable + " WHERE StdClass=?),sex,StDName FROM " + archivedTable + " WHERE StdRegNum = ? AND StdClass = ?";
            final PreparedStatement pstatement5 = this.connection.prepareStatement(QueryString5);
            pstatement5.setString(1, RefrencedClass2);
            pstatement5.setString(2, RegNumber);
            pstatement5.setString(3, RefrencedClass2);
            final ResultSet rs5 = pstatement5.executeQuery();
            while (rs5.next()) {
                final String gender3 = rs5.getObject(2).toString();
                gender2 = rs5.getObject(2).toString();
                this.txtReportGender.setText(gender3);
            ...
            if (RefrencedClass2.equalsIgnoreCase("\u0641\u0635\u0644  \u0627\u0644\u0623\u0645\u0647\u0627\u062a \u0627\u0644\u062e\u0627\u0645\u0633 Promoted2018")) {
                System.out.println("my GENDER" + gender2);
                System.out.println("ref class:" + RefrencedClass2);
                System.out.println("regNum:" + RegNumber);
                System.out.println("Name:" + this.mystudentName);
            }
            rs5.close();
            pstatement5.close();
        }
        ...
        try {
            final String Query = "SELECT comment,Commenter FROM comments WHERE RegNum=? AND Class=? AND Term=? AND Session=? ";
            final PreparedStatement mypstatement = this.connection.prepareStatement("SELECT comment,Commenter FROM comments WHERE RegNum=? AND Class=? AND Term=? AND Session=? ");
            mypstatement.setString(1, RegNumber);
            mypstatement.setString(2, RefrencedClass);
            ...
            for (int i4 = 1; i4 <= columns4; ++i4) {
                this.columnNames5.addElement(md4.getColumnName(i4));
            }
            while (rs6.next()) {
                ...
                for (int i5 = 1; i5 <= columns4; ++i5) {
                    row5.addElement(rs6.getObject(i5));
                }
        ...
        for (int i2 = 0; i2 < this.table5.getColumnCount(); ++i2) {
            this.table.getColumnModel().getColumn(i2);
        }
        this.table5.repaint();
        ...
        final String Section = "TAHFEEZ";
        try {
            final String Query2 = "SELECT Term_Attribute,Term_Information,Arab_Term_Information,Arab_Term_Attribute FROM terminformation WHERE Term=? AND Session=? AND Section=? ORDER BY Term_Attribute DESC";
            final PreparedStatement mypstatement2 = this.connection.prepareStatement("SELECT Term_Attribute,Term_Information,Arab_Term_Information,Arab_Term_Attribute FROM terminformation WHERE Term=? AND Session=? AND Section=? ORDER BY Term_Attribute DESC");
            mypstatement2.setString(1, term);
            mypstatement2.setString(2, Session);
            mypstatement2.setString(3, "TAHFEEZ");
        ...
        for (int i8 = 0; i8 < this.table6.getColumnCount(); ++i8) {
            this.table.getColumnModel().getColumn(i8);
        }
        this.table6.repaint();
        ...
        this.panel.repaint();
        try {
            final String QueryString6 = "SELECT Session FROM terminformation WHERE Term=? AND Section=?";
            final PreparedStatement pstatement6 = this.connection.prepareStatement("SELECT Session FROM terminformation WHERE Term=? AND Section=?");
            pstatement6.setString(1, term);
            pstatement6.setString(2, "TAHFEEZ");
            final ResultSet rs8 = pstatement6.executeQuery();
            while (rs8.next()) {
        ...
        try {
            ...
            for (int i9 = 1; i9 <= columns6; ++i9) {
                this.columnNames8.addElement(md6.getColumnName(i9));
            }
            while (rs9.next()) {
                final Vector row7 = new Vector(columns6);
                for (int i10 = 1; i10 <= columns6; ++i10) {
                    row7.addElement(rs9.getObject(i10));
                }
        ...
        for (int i11 = 0; i11 < this.table8.getColumnCount(); ++i11) {
