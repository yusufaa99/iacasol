...
public class studentInvoiceReport extends JFrame
{
    private static final long serialVersionUID = 1L;
    ResultSet rs_checks_balance = null;
    int check_balance_counter = 0;
    int acctCounter;
    ...
    private JButton btnPreviewPerStudent;
    ...
    private JLabel lblFeesList;
    private JComboBox CombofeesList; 
    ...
    public studentInvoiceReport() {
        ...
        this.f2 = new Font("Arial Unicode MS", 1, 14);
    ...
    public void studentInvoiceReport() {
        ...
        this.btnPreview = new JButton("Preview Consolidated Invoice by Session");
        btnPreviewPerStudent = new JButton("Preview Current Invoice");

        btnPreview.setFont(f2);
        btnPreviewPerStudent.setFont(f2);
        ...
        lblFeesList =  new JLabel("FEES LIST: ");
        CombofeesList = new JComboBox();
        CombofeesList.addItem("SELECT FEES");
        CombofeesList.addItem("BALANCE PAYMENT");
        CombofeesList.addItem("SCHOOL FEES");
        CombofeesList.addItem("EXAMS FEES");        
        CombofeesList.addItem("BOOKS");
        CombofeesList.addItem("SPORTWEAR");
        CombofeesList.setFont(f);//assigned a given font
        CombofeesList.setForeground(Color.BLUE);
        CombofeesList.setBackground(Color.WHITE);
...
//        table.setAutoResizeMode(5);
        ...
        paneScrollPane.setPreferredSize(new Dimension(990, 190));
        paneScrollPane.setBackground(Color.cyan);
        this.textPane.insertIcon(new ImageIcon("studentInvoiceReport.png"));
        ...
        this.setSize(1150, 505);
        this.setTitle("Student Invoice Report");
        this.add(this.panel);
        ...
        this.btnPreviewPerStudent.setBackground(Color.WHITE);
        this.btnPreviewPerStudent.setForeground(Color.RED);
       ...
       // this.addItem(this.panel, this.lblFeesList, 0, 7, 1, 1, 13);
      //  this.addItem(this.panel, this.CombofeesList, 1, 7, 3, 1, 17);
        
       // this.addItem(this.panel, this.lblTotalFeesPaid, 0, 8, 1, 1, 13);
       // this.addItem(this.panel, this.txtTotalFeesPaid, 1, 8, 3, 1, 17);
      ...
      //  this.addItem(this.panel2, this.lblTest1Marks, 0, 2, 1, 1, 13);
        ...
        ButtonsBox.add(Box.createHorizontalStrut(3)); 
        ButtonsBox.add(this.btnPreviewPerStudent);
        ButtonsBox.add(Box.createHorizontalStrut(3)); 
...
//        ButtonsBox.add(Box.createHorizontalStrut(3));
       ...
       // ButtonsBox.add(this.btnDeregister);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                studentInvoiceReport.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                studentInvoiceReport.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                studentInvoiceReport.this.connectToDB();
                studentInvoiceReport.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                studentInvoiceReport.this.connectToDB();
                studentInvoiceReport.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                studentInvoiceReport.this.connectToDB();
                studentInvoiceReport.this.btnSaveMethod(evt5);
            }
        });
        ...
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                studentInvoiceReport.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                studentInvoiceReport.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPreviewPerStudent.addActionListener(new ActionListener() {
            public void actionPerfomed(final ActionEvent e11) {
            }
            
            @Override
            public void actionPerformed(final ActionEvent evt11) {
                studentInvoiceReport.this.btnPreviewPerStudentMethod(evt11);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                studentInvoiceReport.this.connectToDB();
                studentInvoiceReport.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                studentInvoiceReport.this.connectToDB();
                studentInvoiceReport.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    studentInvoiceReport.this.btnSave.doClick();
                }
            }
        });
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    studentInvoiceReport.this.btnNext.doClick();
                }
            }
        });
    ...
    public void btnSaveMethod(final ActionEvent evt5) {  
         ...
         if (SaveButton == 0) {
             ...
             String PaymentOption = CombofeesList.getSelectedItem().toString();
              ...
              int payment_counter = 0;
                check_balance_counter = 0;
              String check_balance_Session ="";
              String check_balance_Term ="";
              double check_balance_Balance = 0.0;
              String check_balance_paymentOptions ="";
           ...
           //Step-1.
             ...
             if (mySession.equals("Select Session")) {
                 ...
                 JOptionPane.showMessageDialog(null, " Student Categorization Error!, \nThis student has NOT been categorized! \n Pls, do so to continue!", "Error Occured", 0);
             } 
             else {
                ...
                double balance = 0.0;
            	check_balance_counter = 0;//resetting its initial value
            	
                //CHECKING IF STUDENT HAS OUTSTANDING BALANCE FROM 'student_payment_advice'
                //REETRIVING STUDENT HAS OUTSTANDING BALANCE 
                 
     	        try {
     	        	 final PreparedStatement pstatement_checks  = connection.prepareStatement(" SELECT id,balance,term,session,PAYMENT_OPTION FROM student_payment_advice WHERE Class =? AND Session=? AND RegNum=? order by id desc limit 1 " );//AND BALANCE <=0               
     	             pstatement_checks.setString(1, myclass);
     	             pstatement_checks.setString(2, mySession);
     	             pstatement_checks.setString(3, RegNum);
     	            
     	              rs_checks_balance = pstatement_checks.executeQuery();
     	            check_balance_counter ++; //counter increment 
     	             while (rs_checks_balance.next()) { 
     	            	 int row = rs_checks_balance.getRow();
     	            	check_balance_Balance = rs_checks_balance.getDouble(2);
     	            	check_balance_Term  =  rs_checks_balance.getString(3);
     	            	check_balance_Session =  rs_checks_balance.getString(4);
     	            	check_balance_paymentOptions =  rs_checks_balance.getString(5);
     	            	 
     	             	System.out.println("rowPrint Balance: Testing!"+row);
     	             	System.out.println("Check Balance Counter: Testing!"+check_balance_counter);

     	             	System.out.println("Check Balance: Testing!"+ check_balance_Balance);
      	             }	             		
     			} catch (SQLException a) {
     	            JOptionPane.showMessageDialog(null, "please check your entries\n" + a.getMessage(), "Error occured", 0);
     	            a.printStackTrace();
     	       ...
     	       //CALCULATING the new BALANCE, IF CombofeesList IS FOR CONTINOUS PAYMENT I.E 'BALANCE PAYMENT', "SCHOOL FEES", "EXAMS FEES", "BOOKS", "SPORTWEAR"
                if(CombofeesList.getSelectedItem().toString().equalsIgnoreCase("BALANCE PAYMENT")) {
             	   balance = check_balance_Balance  - TotalAmountPaid;
                }else if(CombofeesList.getSelectedItem().toString().equalsIgnoreCase("SCHOOL FEES")) {
             	   balance = check_balance_Balance + Student_School_fees - TotalAmountPaid;
                }else if(CombofeesList.getSelectedItem().toString().equalsIgnoreCase("EXAMS FEES")) {
              	   balance = check_balance_Balance + Student_Examination_fees - TotalAmountPaid;
                }else if(CombofeesList.getSelectedItem().toString().equalsIgnoreCase("BOOKS")) {
                	   balance = check_balance_Balance +Student_Books_fees - TotalAmountPaid;
                }else if(CombofeesList.getSelectedItem().toString().equalsIgnoreCase("SPORTWEAR")) {
             	   balance = check_balance_Balance + Student_Sportwear_fees - TotalAmountPaid;
                } 
             
                 //CHECKING IF STUDENT IS NOT NEW i.e exits in table ->'student_payment_advice'
                //REETRIVING Continuous Student Information
                 
     	        try {
     	        	 final PreparedStatement pstatement_checks  = connection.prepareStatement(" SELECT * FROM student_payment_advice WHERE Class =? AND RegNum=?" );//AND Session=?               
     	             pstatement_checks.setString(1, myclass);
     	             //pstatement_checks.setString(2, mySession);
     	             pstatement_checks.setString(2, RegNum);
     	       ...
     	       if( CombofeesList.getSelectedItem().toString().equalsIgnoreCase("SELECT FEES")   ) { //checks if select 'Fees Combobox' is selected
   	            JOptionPane.showMessageDialog(null, "Pls, Select Fees! \nPlease, Check Thoroughly and Select Fees! \n", "Error occured", 0);
              }else if( !PaymentOption.equalsIgnoreCase("BALANCE PAYMENT") && check_balance_Balance >0 ) { //check if Balance exist, and payment option is not for 'BALANCE PAYMENT'
    	            JOptionPane.showMessageDialog(null, "OUTSTANDING Balance Exist! \nPlease, Check Thoroughly ! \nThis student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + " has an outstanding balance as follows: \nBalance: "+check_balance_Balance  +" Session: "+ check_balance_Session +" Term: "+ check_balance_Term +" \nYou should clear his/her balance in the 'Continuous Payment' tab.", "Error occured", 0);
               }else if( payment_counter <= 0 ) { //check if row DOES NOT exist
    	            JOptionPane.showMessageDialog(null, "NOT A CONTINUE STUDENT! \nThis student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + "  is a NEW student. \nPlease, implement his/her payment in the 'New Student Payment' tab. \nThank you! ", "Error occured", 0);
               }else if (CombofeesList.getSelectedItem().toString().equalsIgnoreCase("BALANCE PAYMENT") && TotalAmountPaid > check_balance_Balance) {
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED BALANCE! \n Pls, check your entries.", "Error Occured", 0);
                }   else if (CombofeesList.getSelectedItem().toString().equalsIgnoreCase("SCHOOL FEES") && TotalAmountPaid > check_balance_Balance && Student_School_fees <=0 ) {
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED BALANCE! \nThis student: " + Name.toUpperCase() +" RegNumber No: "+ RegNum.toUpperCase() +"\n <<IS ON FULL SCHOLARSHIP>>", "Error Occured", 0);
                }   else if (CombofeesList.getSelectedItem().toString().equalsIgnoreCase("SCHOOL FEES") && TotalAmountPaid > Student_School_fees   ) {
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED School Fees! \n Pls, check your entries.", "Error Occured", 0);
                } else if (CombofeesList.getSelectedItem().toString().equalsIgnoreCase("EXAMS FEES") && TotalAmountPaid > Student_Examination_fees   ) {
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED Exam Fees! \n Pls, check your entries.", "Error Occured", 0);
                } else if (CombofeesList.getSelectedItem().toString().equalsIgnoreCase("BOOKS") && TotalAmountPaid > Student_Books_fees   ) {
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED Books Fees! \n Pls, check your entries.", "Error Occured", 0);
                }  else if (CombofeesList.getSelectedItem().toString().equalsIgnoreCase("SPORTWEAR") && TotalAmountPaid > Student_Books_fees   ) {
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED SportWear Fees! \n Pls, check your entries.", "Error Occured", 0);
                }   else if (!PaymentOption.equalsIgnoreCase("BALANCE PAYMENT") && check_balance_Session.equalsIgnoreCase(mySession) && check_balance_Term.equalsIgnoreCase(Term) ) {
                    JOptionPane.showMessageDialog(null, "Error, IN PAYMENT! " + "\n Payment For: "+PaymentOption + " have been DONE! for this student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + Term +" and Session: "+ mySession + " \n Pls, Select the correct term.", "Error Occured", 0);
                }      
                else {  
             	  	...
             	  	try { ///populating the 'student_payment_advice' table
                         ...
                         pstatement.setDouble(10, 0.0);//my_sum_of_compulsory_fees
                         
                         pstatement.setDouble(11, Student_Books_fees);
                         pstatement.setDouble(12, Student_Sportwear_fees);
                         
                         pstatement.setDouble(13, 0.0);//my_sum_of_non_compulsory_fees
                         
                         pstatement.setDouble(14, 0.0);//my_sum_of_compulsory_fees + my_sum_of_non_compulsory_fees
                         ...
                         if(rowCount >0 ) {
              	            JOptionPane.showMessageDialog(null, "PAYMENT SUCCESS! \nPayment Successfully Received ! \nFor This student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + " \nPayment Option: "+PaymentOption  +" Amount: "+ TotalAmountPaid +" Balance: "+ balance +" \nThank you!", "Payment Infomation", JOptionPane.INFORMATION_MESSAGE);
                         }
...
//    	
    ...
    public void btnPreviewPerStudentMethod(final ActionEvent evt11) {
...
//        } 
        	...
        	try { 
                 ...
                 final PreparedStatement pstatement = connection.prepareStatement(" SELECT Id,Session,Class,RegNum,Name,Term,TOTAL_AMOUNT_PAID,PAYMENT_OPTION,BALANCE,dateCaptured FROM student_payment_advice where Session=? AND Class=? AND RegNum=?  order by id desc limit 1 ");
                pstatement.setString(1, mySession);
                pstatement.setString(2, myclass);
                pstatement.setString(3, RegNum);
...
//        } 
        	...
        	try { 
                 ...
                 final PreparedStatement pstatement = connection.prepareStatement(" SELECT Id,Session,Class,RegNum,Name,Term,TOTAL_AMOUNT_PAID,PAYMENT_OPTION,BALANCE,dateCaptured FROM student_payment_advice where Session=? AND Class=? AND RegNum=? order by id asc ");
                pstatement.setString(1, mySession);
                pstatement.setString(2, myclass);
                pstatement.setString(3, RegNum);
