...
public class ReportSheet7 extends JFrame
{
    ...
    static {
        ReportSheet7.printer = new J2Printer("");
    }
    ...
    public static void setOnScreen(final boolean val) {
        ReportSheet7.onScreen = val;
    }
    
    public void ReportSheet7() {
        this.logotitle = "";
        ...
        this.textPane.insertIcon(new ImageIcon("ummahatSectionLogo.jpg"));
        ...
        this.setTitle("Report Sheet Output Window [Ummahat Type I]");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ReportSheet7.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ReportSheet7.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ReportSheet7.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        ...
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnSubjectGaringMethod(evt15);
            }
        });
        ...
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ReportSheet7.this.connectToDB();
                ReportSheet7.this.btnPreviousMethod(evt18);
            }
        });
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int col) {
                ...
                int tablerowsize = 0;
                final String myClass = (String)ReportSheet7.this.ComboSelecClass.getSelectedItem();
                ...
                else if (ReportSheet7.this.rowCountForStud <= 3) {
                    tablerowsize = ReportSheet7.this.rowCountForStud * 24;
                }
                else if (ReportSheet7.this.rowCountForStud == 4) {
                    tablerowsize = ReportSheet7.this.rowCountForStud * 22;
                }
                else if (ReportSheet7.this.rowCountForStud == 5) {
                    tablerowsize = ReportSheet7.this.rowCountForStud * 21;
                }
                else if (ReportSheet7.this.rowCountForStud == 6) {
                    tablerowsize = ReportSheet7.this.rowCountForStud * 21;
                }
                ReportSheet7.this.ScrollPane.setPreferredSize(new Dimension(480, tablerowsize));
                return this;
            }
        });
    ...
    public void btnPrintMethod(final ActionEvent evt6) {
        ...
        pj.setPrintable(new Printable() {
            ...
            public int print(final Graphics pg, final PageFormat pf, final int pageNum) {
                ...
                g2.translate(10, 35);
                ReportSheet7.this.textPane.paint(g2);
                return 0;
            }
        });
        if (pj.printDialog()) {
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        if (mySession.equals("Select Session")) {
            ...
            this.panel.repaint();
            try {
                final String QueryString2 = "SELECT COUNT(*) Subject FROM compiledreportsheet WHERE ID = ? AND Term =? AND RegNum=? AND Session = ?";
                final PreparedStatement pstatement2 = this.connection.prepareStatement("SELECT COUNT(*) Subject FROM compiledreportsheet WHERE ID = ? AND Term =? AND RegNum=? AND Session = ?");
