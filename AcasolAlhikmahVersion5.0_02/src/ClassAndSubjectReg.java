...
public class ClassAndSubjectReg extends JFrame
{
    ...
    private JButton btnClassReg;
    private JButton btnAssignSubjectToClass;
    ...
    public void ClassAndSubjectReg() {
        this.panel = new JPanel();
        this.panel2 = new JPanel();
        this.btnPayroll = new JButton("STAFF PAYROLL");
        this.btnClassReg = new JButton("CLASS REGISTRATION");
        this.btnAssignSubjectToClass = new JButton("ASSIGN_SUBJ_TO_CLASS");
        ...
        this.setSize(320, 255);
        this.setTitle("Class_And_Subject_Reg");
        this.add(this.panel);
        ...
        this.btnClassReg.setBackground(Color.GREEN.brighter());
        this.btnClassReg.setForeground(Color.BLACK);
        ...
        this.btnAssignSubjectToClass.setBackground(Color.GREEN.brighter());
        this.btnAssignSubjectToClass.setForeground(Color.BLACK);
        ...
        SDT_REG.add(this.btnClassReg);
        SDT_REG.setBorder(BorderFactory.createTitledBorder("STUDENT REGISTRATION:"));
        this.addItem(this.panel, SDT_REG, 0, 1, 1, 1, 10);
        final Box Subject_Reg = Box.createHorizontalBox();
        Subject_Reg.add(this.btnSubjectReg);
        Subject_Reg.setBorder(BorderFactory.createTitledBorder("SUBJECT REGISTRATION:"));
        this.addItem(this.panel, Subject_Reg, 0, 2, 1, 1, 10);
        final Box assgSubjToClass = Box.createVerticalBox();
        assgSubjToClass.add(this.btnAssignSubjectToClass);
        ...
        this.btnclose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ClassAndSubjectReg.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ClassAndSubjectReg.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ClassAndSubjectReg.this.connectToDB();
                ClassAndSubjectReg.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ClassAndSubjectReg.this.connectToDB();
                ClassAndSubjectReg.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ClassAndSubjectReg.this.connectToDB();
                ClassAndSubjectReg.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ClassAndSubjectReg.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ClassAndSubjectReg.this.btnPreviewMethod(evt7);
            }
        });
        this.btnClassReg.addActionListener(new ActionListener() {
            public void actionPerfomed(final ActionEvent e8) {
            }
            
            @Override
            public void actionPerformed(final ActionEvent evt8) {
                ClassAndSubjectReg.this.btnClassRegMethod(evt8);
            }
        });
        this.btnAssignSubjectToClass.addActionListener(new ActionListener() {
            public void actionPerfomed(final ActionEvent e9) {
            }
            
            @Override
            public void actionPerformed(final ActionEvent evt9) {
                ClassAndSubjectReg.this.btnAssignSubjectToClassMethod(evt9);
            }
        });
        this.btnHWorkAndCWorkDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ClassAndSubjectReg.this.btnHWorkAndCWorkDataEntryMethod(evt10);
            }
        });
        this.btnFirstDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt11) {
                ClassAndSubjectReg.this.btnFirstDataEntryMethod(evt11);
            }
        });
        this.btnSecondDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ClassAndSubjectReg.this.btnSecondDataEntryMethod(evt12);
            }
        });
        this.btnThirdDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ClassAndSubjectReg.this.btnThirdDataEntryMethod(evt13);
            }
        });
        this.btnExamsDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ClassAndSubjectReg.this.btnExamsDataEntryMethod(evt14);
            }
        });
        this.btnCommentDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ClassAndSubjectReg.this.btnCommentDataEntryMethod(evt15);
            }
        });
        this.btnPayroll.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt16) {
                ClassAndSubjectReg.this.btnPayrollMethod(evt16);
            }
        });
        this.btnSchoolHeadInfo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ClassAndSubjectReg.this.btnSchoolHeadInfoMethod(evt18);
            }
        });
        this.btnSubjectReg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt19) {
                ClassAndSubjectReg.this.btnSubjectRegMethod(evt19);
            }
        });
        this.btnArchive.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt20) {
                ClassAndSubjectReg.this.btnArchiveMethod(evt20);
            }
        });
        this.btnStudRegPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt21) {
                ClassAndSubjectReg.this.btnStudRegPreviewMethod(evt21);
            }
        });
        this.btnAccessControl.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt22) {
                ClassAndSubjectReg.this.btnAccessControlMethod(evt22);
            }
        });
    }
    ...
    public void btnClassRegMethod(final ActionEvent evt8) {
        final ClassRegistration SR = new ClassRegistration();
        SR.ClassRegistration();
    }
    
    public void btnAssignSubjectToClassMethod(final ActionEvent evt9) {
        final AssignSubjectToClass assgSubj = new AssignSubjectToClass();
        assgSubj.AssignSubjectToClass();
    }
