...
public class booksAndUniformSpec extends JFrame
{
    ...
    public void booksAndUniformSpec() {
        ...
        this.lblSchFees = new JLabel("SCHOOL FEES:");
        ...
        this.setTitle("Books & Uniform Specifications");
        this.add(this.panel);
        ...
        this.addItem(this.panel, this.lblUniform, 0, 6, 1, 1, 13);
        this.addItem(this.panel, this.txtUniform, 1, 6, 3, 1, 17);
        this.addItem(this.panel, this.lblBooks, 0, 7, 1, 1, 13);
        this.addItem(this.panel, this.txtBooks, 1, 7, 3, 1, 17);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                booksAndUniformSpec.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                booksAndUniformSpec.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                booksAndUniformSpec.this.connectToDB();
                booksAndUniformSpec.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                booksAndUniformSpec.this.connectToDB();
                booksAndUniformSpec.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                booksAndUniformSpec.this.connectToDB();
                booksAndUniformSpec.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                booksAndUniformSpec.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                booksAndUniformSpec.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                booksAndUniformSpec.this.connectToDB();
                booksAndUniformSpec.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                booksAndUniformSpec.this.connectToDB();
                booksAndUniformSpec.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.ComboSelectRate.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    booksAndUniformSpec.this.btnSave.doClick();
                }
            }
        });
        this.ComboSelectRate.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 17) {
                    booksAndUniformSpec.this.btnNext.doClick();
                }
            }
        });
        this.ComboSelectRate.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 18) {
                    booksAndUniformSpec.this.btnPrevious.doClick();
                }
            }
        });
    }
    ...
    public void btnSaveMethod(final ActionEvent evt5) {
        ...
        if (mysection.equals("SELECT SECTION")) {
            ...
            JOptionPane.showMessageDialog(this.btnSave, "Please, enter a session", "Error session Data Entry", 0);
        }
            ...
            JOptionPane.showMessageDialog(this.btnSave, "Please, select term!", "Error in term Data Entry", 0);
        }
        else if (myClass.equalsIgnoreCase("SELECT CLASS")) {
            JOptionPane.showMessageDialog(this.btnSave, "Please, select class!", "Error in Class Data Entry", 0);
        }
        else if (this.txtUniform.getText().equals("") || this.txtUniform.getText().equals("0")) {
            JOptionPane.showMessageDialog(this.btnSave, "Please, enter a valid Uniform fees!", "Error Uniform Fees   Data Entry", 0);
        }
        else if (this.txtBooks.getText().equals("") || this.txtBooks.getText().equals("0")) {
            JOptionPane.showMessageDialog(this.btnSave, "Please, enter a valid Book Fees!", "Error inBook Fees Data Entry", 0);
        }
        else {
            if (SubCharSessionChar.equalsIgnoreCase(this.txtYear.getText().toString())) {
                try {
                    final String InsertQueryString = "INSERT INTO booksAndUniform (session,year,section,term,class,uniformfees,booksfees)VALUES (?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE uniformfees=VALUES(uniformfees), booksfees=VALUES(booksfees)";
                    final PreparedStatement pstatement = this.connection.prepareStatement("INSERT INTO booksAndUniform (session,year,section,term,class,uniformfees,booksfees)VALUES (?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE uniformfees=VALUES(uniformfees), booksfees=VALUES(booksfees)");
                    ...
                    pstatement.setString(6, myUniformFees);
                    pstatement.setString(7, myBooks);
                ...
                JOptionPane.showMessageDialog(this.btnSave, "Please,Check the Session and Year, they must synchronize!", "Error Session and Year", 0);
            }
            this.data.setSize(0);
            ...
            this.panel.repaint();
            this.TextArea.setText("");
            if (mysession.equalsIgnoreCase("") && myYear.equalsIgnoreCase("") && mysection.equalsIgnoreCase("")) {
                JOptionPane.showMessageDialog(null, "Pls, enter session, year or section", "Error Occured", 0);
            }
            else {
                ...
                try {
                    ...
                    final String QueryString = "SELECT * FROM booksAndUniform";
                    final PreparedStatement pstatement2 = con.prepareStatement("SELECT * FROM booksAndUniform");
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        final String mysection = (String)this.ComboSections.getSelectedItem();
        final String myYear = this.txtYear.getText().toString();
        final String mySchfess = this.txtSchFees.getText().toString();
        final String myRegistration = this.txtBooks.getText().toString();
        ...
        try {
            ...
            final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/acasolalhikmahv5?useUnicode=true&characterEncoding=utf-8", "root", "ash123");
            final String QueryString = "SELECT * FROM booksAndUniform";
            final PreparedStatement pstatement = con.prepareStatement("SELECT * FROM booksAndUniform");
            final ResultSet rs = pstatement.executeQuery();
            final ResultSetMetaData md = rs.getMetaData();
            final int columns = md.getColumnCount();
            for (int i = 1; i <= columns; ++i) {
