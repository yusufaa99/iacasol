...
public class continousPayment extends JFrame
{
    ...
    public void continousPayment() {
        ...
        btnPreviewPerStudent = new JButton("Preview_Balance_Per_student");
        ...
        paneScrollPane.setPreferredSize(new Dimension(1290, 150));
        ...
        this.setSize(1320, 565);
        this.setTitle("Continuos Payment System");
        this.add(this.panel);
       ...
       // ButtonsBox.add(this.btnDeregister);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                continousPayment.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                continousPayment.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                continousPayment.this.connectToDB();
                continousPayment.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                continousPayment.this.connectToDB();
                continousPayment.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                continousPayment.this.connectToDB();
                continousPayment.this.btnSaveMethod(evt5);
            }
        });
        ...
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                continousPayment.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                continousPayment.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPreviewPerStudent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt11) {
                continousPayment.this.btnPreviewPerStudentMethod(evt11);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                continousPayment.this.connectToDB();
                continousPayment.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                continousPayment.this.connectToDB();
                continousPayment.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    continousPayment.this.btnSave.doClick();
                }
            }
        });
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    continousPayment.this.btnNext.doClick();
                }
            }
        });
   	            ...
   	            JOptionPane.showMessageDialog(null, "Pls, Select Fees! \nPlease, Check Thoroughly and Select Fees! \n", "Error occured", 0);
                    ...
                    JOptionPane.showMessageDialog(null, "Error, IN PAYMENT! " + "\n Payment For: "+PaymentOption + " have been DONE! for this student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + Term +" and Session: "+ mySession + " \n Pls, Select the correct term.", "Error Occured", 0);
             	  	...
             	  	try { ///populating the 'student_payment_advice' table
                         ...
                         pstatement.setDouble(6, Student_School_fees);
                         pstatement.setDouble(7, Student_Registration_fees);
                         pstatement.setDouble(8, Student_Uniform_fees);
                         pstatement.setDouble(9, Student_Utility_fees);
                         pstatement.setDouble(10, Student_Examination_fees);
                         
                         pstatement.setDouble(11, 0.0);//my_sum_of_compulsory_fees
                         
                         pstatement.setDouble(12, Student_Books_fees);
                         pstatement.setDouble(13, Student_Sportwear_fees);
                         
                         pstatement.setDouble(14, 0.0);//my_sum_of_non_compulsory_fees
                         
                         pstatement.setDouble(15, 0.0);//my_sum_of_compulsory_fees + my_sum_of_non_compulsory_fees
                         
                         pstatement.setDouble(16, TotalAmountPaid);
                         pstatement.setString(17, PaymentOption);
                          
                         pstatement.setDouble(18, balance);
...
//                g2.translate(10, 35);
//                continousPayment.this.textPane.paint(g2);  
//                return 0;
//            }
//        });
//        if (pj.printDialog()) {
...
//        } 
        	...
        	try { 
                 ...
                 final PreparedStatement pstatement = connection.prepareStatement(" SELECT * FROM student_payment_advice where Session=? AND Class=? AND RegNum=? order by id asc ");
                pstatement.setString(1, mySession);
                pstatement.setString(2, myclass);
                pstatement.setString(3, RegNum);
