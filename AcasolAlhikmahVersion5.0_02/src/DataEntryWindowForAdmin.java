...
public class DataEntryWindowForAdmin extends JFrame
{
    ...
    private JButton btnAttaqSpecification;
    ...
    public void DataEntryWindowForAdmin() {
        ...
        this.btnAttaqSpecification = new JButton("ATTAQDEER SPECIFICATION");
        ...
        this.setSize(320, 605);
        this.setTitle("Staff Data Entry Window - For Secondary School");
        this.add(this.panel);
        ...
        this.btnStudentDataCapture.setBackground(Color.GREEN.brighter());
        ...
        this.btnAttaqSpecification.setBackground(Color.GREEN.brighter());
        this.btnAttaqSpecification.setForeground(Color.BLACK);
        this.btnTermInformation.setBackground(Color.GREEN);
        this.btnTermInformation.setForeground(Color.BLACK);
        this.btnStaffDataCapture.setBackground(Color.black);
        this.btnStaffDataCapture.setForeground(Color.WHITE);
        ...
        this.addItem(this.panel, SDC, 0, 1, 1, 1, 10);
        final Box TermInfo = Box.createHorizontalBox();
        TermInfo.add(this.btnTermInformation);
        TermInfo.setBorder(BorderFactory.createTitledBorder("TERM INFORMATION:"));
        this.addItem(this.panel, TermInfo, 0, 2, 1, 1, 10);
        final Box STDBox = Box.createVerticalBox();
        STDBox.add(this.btnStaffDataCapture);
        STDBox.setBorder(BorderFactory.createTitledBorder("STAFF DATA CAPTURE:"));
        this.addItem(this.panel, STDBox, 0, 3, 1, 1, 10);
        ...
        this.addItem(this.panel, prBox, 0, 4, 1, 1, 10);
        ...
        this.addItem(this.panel, SchoolHeadInfoBox, 0, 5, 1, 1, 10);
        ...
        this.addItem(this.panel, StaffEditBox, 0, 6, 1, 1, 10);
        ...
        this.addItem(this.panel, btnArchiveBox, 0, 7, 1, 1, 10);
        ...
        this.addItem(this.panel, SrQp, 0, 8, 1, 1, 10);
        ...
        this.addItem(this.panel, accessControl, 0, 9, 1, 1, 10);
        final Box AttaqdeerSpec = Box.createHorizontalBox();
        AttaqdeerSpec.add(this.btnAttaqSpecification);
        AttaqdeerSpec.setBorder(BorderFactory.createTitledBorder("ATTAQDEER SPECIFICATION"));
        this.addItem(this.panel, AttaqdeerSpec, 0, 10, 1, 1, 10);
        this.addItem(this.panel, this.btnclose, 0, 11, 1, 1, 10);
        ...
        this.btnclose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                DataEntryWindowForAdmin.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                DataEntryWindowForAdmin.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                DataEntryWindowForAdmin.this.connectToDB();
                DataEntryWindowForAdmin.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                DataEntryWindowForAdmin.this.connectToDB();
                DataEntryWindowForAdmin.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                DataEntryWindowForAdmin.this.connectToDB();
                DataEntryWindowForAdmin.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                DataEntryWindowForAdmin.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                DataEntryWindowForAdmin.this.btnPreviewMethod(evt7);
            }
        });
        this.btnStudentDataCapture.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                DataEntryWindowForAdmin.this.btnStudentDataCaptureMethod(evt8);
            }
        });
        this.btnStaffDataCapture.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                DataEntryWindowForAdmin.this.btnStaffDataCaptureMethod(evt9);
            }
        });
        this.btnHWorkAndCWorkDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                DataEntryWindowForAdmin.this.btnHWorkAndCWorkDataEntryMethod(evt10);
            }
        });
        this.btnFirstDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt11) {
                DataEntryWindowForAdmin.this.btnFirstDataEntryMethod(evt11);
            }
        });
        this.btnSecondDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                DataEntryWindowForAdmin.this.btnSecondDataEntryMethod(evt12);
            }
        });
        this.btnThirdDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                DataEntryWindowForAdmin.this.btnThirdDataEntryMethod(evt13);
            }
        });
        this.btnExamsDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                DataEntryWindowForAdmin.this.btnExamsDataEntryMethod(evt14);
            }
        });
        this.btnCommentDataEntry.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                DataEntryWindowForAdmin.this.btnCommentDataEntryMethod(evt15);
            }
        });
        this.btnPayroll.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt16) {
                DataEntryWindowForAdmin.this.btnPayrollMethod(evt16);
            }
        });
        this.btnEditStaffInfo.addActionListener(new ActionListener() {
            public void actionPerfomed(final ActionEvent e17) {
            }
            
            @Override
            public void actionPerformed(final ActionEvent evt17) {
                DataEntryWindowForAdmin.this.btnEditStaffInfoMethod(evt17);
            }
        });
        this.btnSchoolHeadInfo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                DataEntryWindowForAdmin.this.btnSchoolHeadInfoMethod(evt18);
            }
        });
        this.btnTermInformation.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt19) {
                DataEntryWindowForAdmin.this.btnTermInformationMethod(evt19);
            }
        });
        this.btnArchive.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt20) {
                DataEntryWindowForAdmin.this.btnArchiveMethod(evt20);
            }
        });
        this.btnStudRegPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt21) {
                DataEntryWindowForAdmin.this.btnStudRegPreviewMethod(evt21);
            }
        });
        this.btnAccessControl.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt22) {
                DataEntryWindowForAdmin.this.btnAccessControlMethod(evt22);
            }
        });
        this.btnAttaqSpecification.addActionListener(new ActionListener() {
            public void actionPerfomed(final ActionEvent e22) {
            }
            
            @Override
            public void actionPerformed(final ActionEvent evt23) {
                DataEntryWindowForAdmin.this.btnAttaqSpecificationMethod(evt23);
            }
        });
    }
    ...
    public void btnTermInformationMethod(final ActionEvent evt19) {
    ...
    public void btnAttaqSpecificationMethod(final ActionEvent evt23) {
        final AttaqdeerSpecification attaqdeerSpec = new AttaqdeerSpecification();
        attaqdeerSpec.AttaqdeerSpecification();
    }
