...
public class Graduating_Class_List extends JFrame
{
    ...
    public void Graduating_Class_List() {
        ...
        this.setSize(715, 412);
        this.setTitle("[AcasolV5.0_02] Graduating_Class_List");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                Graduating_Class_List.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                Graduating_Class_List.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                Graduating_Class_List.this.connectToDB();
                Graduating_Class_List.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                Graduating_Class_List.this.connectToDB();
                Graduating_Class_List.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                Graduating_Class_List.this.connectToDB();
                Graduating_Class_List.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                Graduating_Class_List.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                Graduating_Class_List.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                Graduating_Class_List.this.connectToDB();
                Graduating_Class_List.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                Graduating_Class_List.this.connectToDB();
                Graduating_Class_List.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    Graduating_Class_List.this.btnNext.doClick();
                }
            }
        });
        this.ComboSection.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    Graduating_Class_List.this.btnSave.doClick();
                }
            }
        });
        this.btnDeregister.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                Graduating_Class_List.this.btnDeregisterMethod(evt10);
            }
        });
    ...
    public void btnDeregisterMethod(final ActionEvent evt10) {
        ...
        if (DeleteButton == 0) {
            ...
            if (mySession.equals("Select Session")) {
                ...
                try {
                    this.connectToDB();
                    final String QueryString = "SELECT Classname_Ara FROM Graduating_class WHERE Classname_Ara =? ";
                    final PreparedStatement pstatement = this.connection.prepareStatement("SELECT Classname_Ara FROM Graduating_class WHERE Classname_Ara =? ");
                ...
                if (myClassName_Arabic.equalsIgnoreCase("")) {
                    JOptionPane.showMessageDialog(null, "Pls, Class not ADDED", "Error Occured", 0);
                }
                else if (counterForDeletion <= 0) {
                    JOptionPane.showMessageDialog(null, "The selected class does NOT EXIST in the Databse!", "Error Occured", 0);
                }
                else {
                    try {
                        this.connectToDB();
                        final String QueryString = "DELETE FROM Graduating_class WHERE Classname_Ara =? AND Session =?  ";
                        final PreparedStatement pstatement = this.connection.prepareStatement("DELETE FROM Graduating_class WHERE Classname_Ara =? AND Session =?  ");
                        pstatement.setString(1, myClassName_Arabic);
                    ...
                    try {
                        ...
                        final String QueryString2 = "SELECT * FROM Graduating_class";
                        final PreparedStatement pstatement2 = con.prepareStatement("SELECT * FROM Graduating_class");
    ...
    public void btnSaveMethod(final ActionEvent evt5) {
        ...
        if (SaveButton == 0) {
            final String myClassName_Eng = this.ComboSelecClass_English.getSelectedItem().toString();
            final String myClassName_Arch = String.valueOf(String.valueOf(this.ComboSelecClass_English.getSelectedItem().toString())) + "_Arch";
            final String myClassName_Arabic = this.ComboSelecClass.getSelectedItem().toString();
            final String mySession = this.ComboSession.getSelectedItem().toString();
            final String ClassStatus = "Active";
            ...
            if (mySession.equals("Select Session")) {
            ...
            else if (TheClassName_Arabic.equals(myClassName_Arabic)) {
                JOptionPane.showMessageDialog(null, "Error: This Class Has been ADDED! \nArabic: " + TheClassName_Arabic, "Error Occured", 0);
            }
            else {
                try {
                    final String InsertQueryString = "INSERT INTO Graduating_class (Graduating_class_id,Classname_Ara,Session)VALUES (?,?,?) ";
                    final PreparedStatement pstatement = this.connection.prepareStatement("INSERT INTO Graduating_class (Graduating_class_id,Classname_Ara,Session)VALUES (?,?,?) ");
                    pstatement.setString(1, null);
                    pstatement.setString(2, myClassName_Arabic);
                    pstatement.setString(3, mySession);
                    pstatement.executeUpdate();
                    JOptionPane.showMessageDialog(null, "  The  Class: " + myClassName_Arabic + "\n " + "IS BEEN ADDED in the List");
                    pstatement.close();
                }
                catch (SQLException e) {
                ...
                this.TextArea.setText("");
                if (myClassName_Arabic.equalsIgnoreCase("")) {
                    JOptionPane.showMessageDialog(null, "Pls, Class_Arabic not selected", "Error Occured", 0);
                }
                else {
                    try {
                        this.connectToDB();
                        final String QueryString = "SELECT * FROM Graduating_class";
                        final PreparedStatement pstatement = this.connection.prepareStatement("SELECT * FROM Graduating_class");
                        final ResultSet rs = pstatement.executeQuery();
