...
public class ReportSheet4 extends JFrame
{
    ...
    Double  mumtazLeastMark;
    Double jaidDiddanLeastMark;
    Double jaidLeastMark;
    Double maqbuulLeastMark;
    Double rusuubLeastMark;
    Double rowCountForStud;
    ...
    static {
        ReportSheet4.printer = new J2Printer("");
    }
    ...
    public ReportSheet4() {
        ...
        this.mumtazLeastMark = 0.0;
        this.jaidDiddanLeastMark = 0.0;
        this.jaidLeastMark = 0.0;
        this.maqbuulLeastMark = 0.0;
        this.rusuubLeastMark = 0.0;
        this.rowCountForStud = 0.0;
        this.Hwork = 0.0;
        this.Cwork = 0.0;
    ...
    public static void setOnScreen(final boolean val) {
        ReportSheet4.onScreen = val;
    }
    
    public void ReportSheet4() {
        this.logotitle = "";
       ...
       // this.ComboSession.setEditable(false);
        ...
        this.setTitle("Report Sheet Output Window [JSS SECTION]");
        this.add(this.panel);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                ReportSheet4.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                ReportSheet4.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnSaveMethod(evt5);
            }
        });
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                ReportSheet4.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnPreviewMethod(evt7);
            }
        });
        this.btnGenerateGradePositionAndRemarks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnGenerateGradePositionAndRemarksMethod(evt9);
            }
        });
        this.btnGenerateCAandExamsandTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt10) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnGenerateCAandExamsandTotal(evt10);
            }
        });
        this.btnCOmputeCHTotal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt12) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnCOmputeCHTotalMethod(evt12);
            }
        });
        this.btnGenerateTatalAverageAndActualPosition.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt13) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnGenerateTatalAverageAndActualPositionMethod(evt13);
            }
        });
        this.btnGenerateClassTermAnd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt14) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnGenerateClassTermAndMethod(evt14);
            }
        });
        this.btnSubjectGrading.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt15) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnSubjectGaringMethod(evt15);
            }
        });
        ...
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt18) {
                ReportSheet4.this.connectToDB();
                ReportSheet4.this.btnPreviousMethod(evt18);
            }
        });
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int col) {
                ...
                int tablerowsize = 0;
                final String myClass = (String)ReportSheet4.this.ComboSelecClass.getSelectedItem();
                ...
                else if (ReportSheet4.this.rowCountForStud <= 3) {
                    tablerowsize = (int) (ReportSheet4.this.rowCountForStud * 24);
                }
                else if (ReportSheet4.this.rowCountForStud == 4) {
                    tablerowsize = (int) (ReportSheet4.this.rowCountForStud * 22);
                }
                else if (ReportSheet4.this.rowCountForStud == 5) {
                    tablerowsize = (int) (ReportSheet4.this.rowCountForStud * 20);
                }
                else if (ReportSheet4.this.rowCountForStud == 6) {
                    tablerowsize = (int) (ReportSheet4.this.rowCountForStud * 20);
                } else if (ReportSheet4.this.rowCountForStud >=7 ) {
                    tablerowsize = (int) (ReportSheet4.this.rowCountForStud * 18);
                }else if (ReportSheet4.this.rowCountForStud >=12 ) {
                    tablerowsize = (int) (ReportSheet4.this.rowCountForStud * 9);
                }else if (ReportSheet4.this.rowCountForStud >=14 ) {
                    tablerowsize = (int) (rowCountForStud * 1);
                }
                ReportSheet4.this.ScrollPane.setPreferredSize(new Dimension(600, tablerowsize));
                tablerowsize = 0;
                return this;
            }
        });
    ...
    public void btnNextMethod(final ActionEvent e4) {
        ...
        try {
            ...
            final String ClassName = this.pulledClassName_Eng.replaceAll("-", "_").replaceAll("\\s","").toLowerCase();
    ...
    public void btnPrintMethod(final ActionEvent evt6) {
        ...
        pj.setJobName("ReportSheet4Printing");
        pj.setPrintable(new Printable() {
            ...
            public int print(final Graphics pg, final PageFormat pf, final int pageNum) {
                ...
                g2.translate(10, 35);
                ReportSheet4.this.textPane.paint(g2);
                return 0;
            }
        });
        if (pj.printDialog()) {
    ...
    public void btnPreviewMethod(final ActionEvent evt7) {
        ...
        if (mySession.equals("Select Session")) {
            ...
            try {
                ...
                final PreparedStatement pstatement = this.connection.prepareStatement("SELECT Subject_ENG,Grade,POSITION,REMARKS,TOTAL,EXAMS_60,CA_40,SUBJECT FROM compiledreportsheet WHERE ID=? and Class=? and Term=? AND Session = ? order by CASE WHEN Subject IN ('English','Mathematics','Basic Science and Technology') THEN -1 ELSE Subject END, Subject ASC");
                pstatement.setString(1, ID);
                pstatement.setString(2, myclass);//myclass
            ...
            try {
                ...
                this.rowCountForStud = (Double)this.SujectRowCount;
            ...
            this.panel.validate();
            this.panel.repaint();
            StudClassRegTableName = this.pulledClassName_Eng.replaceAll("-", "_").replaceAll("\\s","").toLowerCase();
            try {
        ...
        try {
            ...
            mypstatement2.setString(2, "TAHFEEZ");
        ...
        try {
            ...
            pstatement7.setString(2, "TAHFEEZ");
    ...
    public void computingGradeMethod() {
        ...
        try {
            ...
            while (rs.next()) {
                //this.mumtazLeastMark = Integer.parseInt(rs.getString(1));
            	 this.mumtazLeastMark =   Double.parseDouble(rs.getString(1));
        ...
        try {
            ...
            rs = pstatement.executeQuery();
            while (rs.next()) {
                 this.jaidDiddanLeastMark =  Double.parseDouble(rs.getString(1));
                System.out.println("pulled Least Mark: " + this.jaidDiddanLeastMark);
            }
            pstatement.close();
        }
        ...
        try {
            ...
            rs = pstatement.executeQuery();
            while (rs.next()) {
                 this.jaidLeastMark =   Double.parseDouble(rs.getString(1));
                System.out.println("pulled Least Mark: " + this.jaidDiddanLeastMark);
            }
            pstatement.close();
        }
        ...
        try {
            ...
            rs = pstatement.executeQuery();
            while (rs.next()) {
                 this.maqbuulLeastMark = Double.parseDouble(rs.getString(1));
                System.out.println("pulled Least Mark: " + this.jaidDiddanLeastMark);
            }
            pstatement.close();
        }
        ...
        try {
            ...
            rs = pstatement.executeQuery();
            while (rs.next()) {
                 this.rusuubLeastMark = Double.parseDouble(rs.getString(1));
                System.out.println("pulled Least Mark: " + this.jaidDiddanLeastMark);
            }
            pstatement.close();
        }
        ...
        try {
            ...
            pstatement.setDouble(1, this.mumtazLeastMark);
            pstatement.setDouble(2, this.jaidDiddanLeastMark);
            pstatement.setDouble(3, this.jaidLeastMark);
            pstatement.setDouble(4, this.maqbuulLeastMark);
