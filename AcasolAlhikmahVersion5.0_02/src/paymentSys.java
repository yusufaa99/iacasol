...
public class paymentSys extends JFrame
{
    ...
    public void paymentSys() {
        ...
        this.addItem(this.panel, this.lblTotalFeesPaid, 0, 7, 1, 1, 13);
        this.addItem(this.panel, this.txtTotalFeesPaid, 1, 7, 3, 1, 17);
       ...
       // ButtonsBox.add(this.btnDeregister);
        ...
        this.btnClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt1) {
                paymentSys.this.btnCloseMethod(evt1);
            }
        });
        this.btnClear.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt2) {
                paymentSys.this.btnClearMethod(evt2);
            }
        });
        this.btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt3) {
                paymentSys.this.connectToDB();
                paymentSys.this.btnSearchMethod(evt3);
            }
        });
        this.btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt4) {
                paymentSys.this.connectToDB();
                paymentSys.this.btnNextMethod(evt4);
            }
        });
        this.btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt5) {
                paymentSys.this.connectToDB();
                paymentSys.this.btnSaveMethod(evt5);
            }
        });
        ...
        this.btnPrint.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt6) {
                paymentSys.this.btnPrintMethod(evt6);
            }
        });
        this.btnPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt7) {
                paymentSys.this.btnPreviewMethod(evt7);
            }
        });
        this.btnPrevious.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt8) {
                paymentSys.this.connectToDB();
                paymentSys.this.btnPreviousMethod(evt8);
            }
        });
        this.ComboSelecClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt9) {
                paymentSys.this.connectToDB();
                paymentSys.this.ComboSelecClassMethod(evt9);
            }
        });
        ...
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    paymentSys.this.btnSave.doClick();
                }
            }
        });
        this.txtExamMarks.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(final KeyEvent e) {
                if (e.getKeyCode() == 32) {
                    paymentSys.this.btnNext.doClick();
                }
            }
        });
             ...
             if (mySession.equals("Select Session")) {
              ...
              //CHECKING IF STUDENT HAS OUTSTANDING BALANCE FROM 'student_payment_advice'
                //REETRIVING STUDENT HAS OUTSTANDING BALANCE 
     	        ...
     	        try {
     	        	 final PreparedStatement pstatement_checks  = connection.prepareStatement(" SELECT balance,term,session FROM student_payment_advice WHERE Class =? AND Session=? AND RegNum=? " );               
     	             ...
     	             while (rs_checks.next()) { 
     	            	check_balance_Balance = rs_checks.getString(1);
     	            	check_balance_Term  =  rs_checks.getString(2);
     	            	check_balance_Session =  rs_checks.getString(3);
                ...
                //REETRIVING Student_Sportwear_fees
     	        ...
     	        try {
     	        	 final PreparedStatement pstatement_checks  = connection.prepareStatement(" SELECT * FROM student_payment_advice WHERE Class =? AND Session=? AND RegNum=? " );// AND Term=?            
     	             pstatement_checks.setString(1, myclass);
     	             pstatement_checks.setString(2, mySession);
     	             pstatement_checks.setString(3, RegNum);
     	           // pstatement_checks.setString(4, Term);
     	             final ResultSet rs_checks = pstatement_checks.executeQuery();
     	             while (rs_checks.next()) {
     	             	payment_counter ++;      
      	             }	             		
                ...
                if(check_balance_counter > 0 ) { //check if Balance exist
                ...
                }else if(payment_counter > 0 ) { //check if row exist
     	            JOptionPane.showMessageDialog(null, "Duplicate Entry! \nPayment for this student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + " and Term: " + Term.toUpperCase() + " has been recieved already. \n But you can clear his balance (if any) in the 'Continuous Payment' tab. ", "Error occured", 0);
                    ...
                    JOptionPane.showMessageDialog(null, "Error, You cannot pay morethan the EXPECTED AMOUNT! \n Pls, check your entries.", "Error Occured", 0);
             	  	...
             	  	try { ///populating the 'student_payment_advice' table
                         ...
                         pstatement.setDouble(11, my_sum_of_compulsory_fees);
                          
                         pstatement.setDouble(12, Student_Books_fees);
                         pstatement.setDouble(13, Student_Sportwear_fees);
                         
                         pstatement.setDouble(14, my_sum_of_non_compulsory_fees);
                         
                         pstatement.setDouble(15, my_sum_of_compulsory_fees + my_sum_of_non_compulsory_fees);
                         ...
                         if(rowCount >0 ) {
                          //   JOptionPane.showMessageDialog(null, "Payment successfully received. \n Thank you.", "Payment Information", JOptionPane.INFORMATION_MESSAGE);
                             JOptionPane.showMessageDialog(null, "PAYMENT Successfully Received. \nCongratulations ! \nThis student: "+ Name.toUpperCase() +", RegNumber No: "+ RegNum.toUpperCase() + "\nHas successfully paid: "+ TotalAmountPaid+ " For: "+ PaymentOption  +" Session: "+ mySession +" Term: "+ Term+ "\nPlease, print his/her invoice in the 'Student Invoice Report' tab. ", "Error occured", JOptionPane.INFORMATION_MESSAGE);
                         }
